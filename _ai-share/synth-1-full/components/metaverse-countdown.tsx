  ...
  return (
    <div className="flex justify-center gap-4 md:gap-8">
      <div className="text-center p-4 bg-white/10 rounded-lg w-24 md:w-32 backdrop-blur-sm border border-white/10">
        <p className="font-headline text-4xl md:text-6xl font-bold">{formatNumber(timeLeft.days)}</p>
        <p className="text-sm md:text-base text-gray-300 uppercase tracking-widest">Дней</p>
      </div>
      <div className="text-center p-4 bg-white/10 rounded-lg w-24 md:w-32 backdrop-blur-sm border border-white/10">
        <p className="font-headline text-4xl md:text-6xl font-bold">{formatNumber(timeLeft.hours)}</p>
        <p className="text-sm md:text-base text-gray-300 uppercase tracking-widest">Часов</p>
      </div>
      <div className="text-center p-4 bg-white/10 rounded-lg w-24 md:w-32 backdrop-blur-sm border border-white/10">
        <p className="font-headline text-4xl md:text-6xl font-bold">{formatNumber(timeLeft.minutes)}</p>
        <p className="text-sm md:text-base text-gray-300 uppercase tracking-widest">Минут</p>
      </div>
      <div className="text-center p-4 bg-white/10 rounded-lg w-24 md:w-32 backdrop-blur-sm border border-white/10">
        <p className="font-headline text-4xl md:text-6xl font-bold">{formatNumber(timeLeft.seconds)}</p>
