            ...
            <DialogContent className="sm:max-w-4xl grid grid-cols-1 md:grid-cols-2 p-0">
                <div className="p-8 flex flex-col">
                    <DialogHeader>
                        ...
                        <DialogTitle className="text-3xl font-bold mt-2">{nft.name}</DialogTitle>
                ...
                <div className="bg-secondary/50 flex items-center justify-center p-8 rounded-r-lg relative">
                    {avatarImage && (
                        <Image
