...
Репозиторий монолитный: этот каталог — **фронт** (`_ai-share/synth-1-full/`), **FastAPI** — в корне репозитория. Онбординг, CI (два рабочих каталога) и **матрица окружений demo / FastAPI / prod** описаны в **`../../docs/RUNBOOK.md`**.
