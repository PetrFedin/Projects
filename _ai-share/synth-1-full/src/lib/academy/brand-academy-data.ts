...
const BRAND_COURSES: BrandCourse[] = [
  {
    id: 'bc-1',
    title: 'ДНК бренда Syntha',
    description: 'Философия, история и идентичность бренда.',
    modules: 5,
    duration: '~1 ч',
    status: 'completed',
    progress: 100,
  ...
  {
    id: 'bc-2',
    title: 'Продуктовая линейка FW26',
    description: 'Ключевые модели, материалы и USP коллекции.',
    modules: 8,
    duration: '~2 ч',
    status: 'in_progress',
    progress: 45,
  ...
  {
    id: 'bc-3',
    title: 'Процессы B2B и согласование заказов',
    description: 'MOQ, логистика, работа с заказами.',
    modules: 6,
    duration: '~1.5 ч',
    status: 'not_started',
    progress: 0,
...
const DEFAULT_KNOWLEDGE: BrandKnowledgeArticle[] = [
  {
    id: 'k1',
    title: 'О бренде Syntha',
    excerpt: 'Философия, история, ДНК бренда. Что важно знать партнёрам.',
    category: 'brand',
  ...
  {
    id: 'k2',
    title: 'Устойчивое производство: наши стандарты',
    excerpt: 'Эко-материалы, сертификаты, ESG-подход.',
    category: 'industry',
    audience: ['partners'],
  ...
  {
    id: 'k3',
    title: 'Как мы работаем с заказами B2B',
    excerpt: 'Сроки, MOQ, логистика, согласование.',
    category: 'process',
    audience: ['partners'],
...
const DEFAULT_COLLECTION_TRAINING: CollectionTraining[] = [
  {
    id: 'ct1',
    collectionId: 'fw26',
    collectionName: 'FW26 Main',
    season: 'FW26',
    type: 'full',
    title: 'Коллекция FW26: полное обучение',
    description: 'Product knowledge, мерчандайзинг, скрипты продаж.',
    duration: '2 ч',
    modules: 6,
    forStores: true,
  },
  {
    ...
    season: 'FW26',
    type: 'product',
    title: 'Ключевые модели FW26',
    description: 'Материалы, крой, USP каждой модели.',
    duration: '45 мин',
    modules: 3,
    forStores: true,
  },
  {
    id: 'ct3',
    collectionId: 'ss26',
    collectionName: 'SS26 Pre-collection',
    season: 'SS26',
    type: 'merchandising',
    title: 'Мерчандайзинг SS26',
    description: 'Выкладка, зонирование, витрины.',
    duration: '30 мин',
    modules: 2,
    forStores: true,
  },
...
const DEFAULT_CLIENT_MATERIALS: ClientMaterial[] = [
  {
    id: 'cm1',
    collectionId: 'fw26',
    title: 'Уход за изделиями FW26',
    type: 'care',
    description: 'Стирка, хранение, ремонт.',
  },
  {
    id: 'cm2',
    collectionId: 'fw26',
    title: 'Как сочетать FW26',
    type: 'styling',
    description: 'Идеи образов и комбинаций.',
  },
  {
    id: 'cm3',
    title: 'О коллекции FW26',
    type: 'intro',
    description: 'Концепция, вдохновение, ключевые силуэты.',
  },
];
...
export function getBrandKnowledgeArticles(
  audience?: 'team' | 'partners' | 'clients'
): BrandKnowledgeArticle[] {
...
export function addKnowledgeArticle(
  article: Omit<BrandKnowledgeArticle, 'id'>
): BrandKnowledgeArticle {
  const all = loadKnowledge();
  ...
  if (typeof window !== 'undefined')
    localStorage.setItem(STORAGE_KEY_KNOWLEDGE, JSON.stringify(all));
  return newArt;
}

export function addCollectionTraining(
  training: Omit<CollectionTraining, 'id'>
): CollectionTraining {
  const all = loadCollectionTraining();
  ...
  all.push(newT);
  if (typeof window !== 'undefined')
    localStorage.setItem(STORAGE_KEY_COLLECTION, JSON.stringify(all));
  return newT;
}
