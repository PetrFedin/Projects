...
export const JOOR_DELIVERY_WINDOWS: B2BDeliveryWindow[] = [
  { id: 'drop1', label: 'Drop 1: Июль 2026', startShipDate: '2026-07-01', completeShipDate: '2026-07-15', cancelDate: '2026-06-20' },
  { id: 'drop2', label: 'Drop 2: Август 2026', startShipDate: '2026-08-01', completeShipDate: '2026-08-15', cancelDate: '2026-07-20' },
  { id: 'drop3', label: 'Drop 3: Сентябрь 2026', startShipDate: '2026-09-01', completeShipDate: '2026-09-15', cancelDate: '2026-08-20' },
];
