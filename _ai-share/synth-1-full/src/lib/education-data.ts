...
export const glossary: Record<string, { term: string, definition: string }> = {
  'GMROI': {
    ...
    definition: 'Рентабельность инвестиций в запасы по валовой марже. Показывает, сколько валовой прибыли приносит каждый рубль, вложенный в товар.'
  },
  'SKU': {
    term: 'Stock Keeping Unit',
    definition: 'Идентификатор товарной позиции, единица учета запасов. Каждому цвету и размеру модели присваивается свой SKU.'
  },
  'RFID': {
    term: 'Radio Frequency Identification',
    definition: 'Способ автоматической идентификации объектов, при котором посредством радиосигналов считываются данные, хранящиеся в RFID-метках.'
  },
  'ESG': {
    term: 'Environmental, Social, and Governance',
    definition: 'Совокупность стандартов деятельности компании, которые социально ответственные инвесторы используют для проверки потенциальных инвестиций.'
  },
  'ROI': {
    term: 'Return on Investment',
    definition: 'Коэффициент окупаемости инвестиций. Отношение полученной прибыли к сумме вложенных средств.'
  },
  'B2B': {
    term: 'Business-to-Business',
    definition: 'Формат взаимодействия, при котором одна компания продает товары или услуги другой компании.'
  },
  'PLM': {
    term: 'Product Lifecycle Management',
    definition: 'Система управления жизненным циклом изделия: от идеи и дизайна до производства и утилизации.'
  }
};
...
export const mockCourses: EducationCourse[] = [
  {
    ...
    description: 'Глубокое погружение в метрики розничной торговли, юнит-экономику и оптимизацию маржи для владельцев магазинов и байеров.',
  ...
  },
  {
    ...
    description: 'Освойте инструменты завтрашнего дня. Узнайте, как интегрировать AI и 3D-моделирование в ваш процесс проектирования.',
  ...
  },
  {
    ...
    description: 'Как управлять международной логистикой, таможней и этичным сорсингом в современном мире моды.',
  ...
  },
  {
    ...
    description: 'Узнайте, как повысить конверсию офлайн-магазина через научный подход к планировке и сенсорный брендинг.',
  ...
  },
  {
    ...
    description: 'Мастер-класс для основателей о том, как создать идентичность бренда, которая масштабируется глобально.',
...
export const mockArticles: KnowledgeArticle[] = [
  {
    ...
    category: 'Economics',
    excerpt: 'Валовая маржа на инвестиции в запасы (GMROI) — ключевой показатель для управления запасами.',
  ...
  },
  {
    ...
    category: 'Legal',
    excerpt: 'Новые правила, требующие наличия цифровых паспортов для всех текстильных изделий, продаваемых в ЕС.',
...
export const mockAcademyEvents: AcademyEvent[] = [
  {
    ...
    description: 'Присоединяйтесь к нашим ведущим аналитикам для живого разбора прогнозируемых паттернов спроса на следующий сезон.',
    type: 'webinar',
  ...
  },
  {
    ...
    description: 'Практическая сессия по созданию и отслеживанию паспортов продукции с помощью Syntha OS.',
    type: 'workshop',
...
export const mockLearningPaths: LearningPath[] = [
  {
    ...
    description: 'Полный трек для освоения оптовых операций, синхронизации запасов и управления отношениями с партнерами.',
...
export const mockAssessments: Assessment[] = [
  {
    ...
    description: 'Проверьте свои знания в области GMROI, оборачиваемости запасов и процента продаж.',
    courseId: 'course-1',
  ...
  },
  {
    ...
    description: 'Оцените свои навыки в 3D-моделировании и использовании генеративного AI для дизайна текстиля.',
    courseId: 'course-2',
    targetRoles: ['brand', 'manufacturer'],
    category: 'design',
    passingScore: 75,
