...
export const DEMO_SUPPLIERS: SupplierProfile[] = [
  {
    id: 'sup1',
    name: 'Текстиль-М',
    description: 'Ткани и трикотаж для масс-маркета',
    regions: ['Москва', 'МО', 'Вся РФ'],
    categories: ['Ткани'],
    minOrderValue: 50000,
    currency: 'RUB',
  ...
  },
  {
    id: 'sup2',
    name: 'Фурнитура Плюс',
    description: 'Пуговицы, молнии, нитки',
    regions: ['Санкт-Петербург', 'ЛО', 'Вся РФ'],
    categories: ['Фурнитура'],
    minOrderValue: 20000,
    currency: 'RUB',
    active: true,
    updatedAt: '2026-03-01',
  },
  {
    id: 'sup3',
    name: 'CMT Иваново',
    description: 'Раскрой и пошив под заказ',
    regions: ['Иваново', 'Ивановская обл.'],
    categories: ['CMT'],
  ...
  },
  {
    id: 'sup4',
    name: 'Эко-Текстиль',
    description: 'Органический хлопок, переработанные материалы',
    regions: ['Вся РФ'],
    categories: ['Ткани'],
    minOrderValue: 80000,
    currency: 'RUB',
...
export function filterSuppliersByRegion(
