...
export const MOCK_CROSS_LINKS: CrossLink[] = [
  // Александра В. (VIP-клиент из Москвы)
  {
    ...
    to: { type: 'sku', id: 'sku-4821', name: 'Платье FW25 #4821', href: '/brand/products?sku=4821' },
    relation: 'purchased',
    metadata: { volume: 142000, date: '2026-01-15' }
  },
  {
    from: { type: 'sku', id: 'sku-4821', name: 'Платье FW25 #4821', href: '/brand/products?sku=4821' },
    to: { type: 'factory', id: 'f-vostok', name: 'Восток (RU)', href: '/brand/production?factory=vostok' },
    relation: 'produces',
  ...
  {
    from: { type: 'retailer', id: 'r-tsum', name: 'ЦУМ Москва', href: '/brand/retailers?id=r-tsum' },
  ...
  },
  {
    ...
    to: { type: 'sku', id: 'sku-1092', name: 'Куртка Outerwear #1092', href: '/brand/products?sku=1092' },
    relation: 'ordered',
    metadata: { qty: 240, wholesale_price: 12400 }
  },
  {
    from: { type: 'sku', id: 'sku-1092', name: 'Куртка Outerwear #1092', href: '/brand/products?sku=1092' },
    to: { type: 'factory', id: 'f-nordic', name: 'Nordic Wool (FI)', href: '/brand/production?factory=nordic' },
    relation: 'produces',
...
export function findRelated(entityId: string, relation?: CrossLink['relation']): CrossLink[] {
  return MOCK_CROSS_LINKS.filter(link => 
