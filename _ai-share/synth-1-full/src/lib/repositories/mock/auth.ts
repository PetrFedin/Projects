  ...
  const defaultUsers = new Map([
    ...
    ['admin@syntha.ai', {
      ...
      profile: {
        ...
        team: [
          { id: 'admin-001', firstName: 'Александр', lastName: 'Волков', email: 'admin@syntha.ai', role: 'Chief Architect', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop', nickname: 'aleksandr_volkov' },
          { id: 'admin-002', firstName: 'Дмитрий', lastName: 'Соколов', email: 'dmitry@syntha.ai', role: 'Technical Director', avatar: 'https://images.unsplash.com/photo-1519085360753-afdab827c52f?w=400&h=400&fit=crop', nickname: 'dmitry_sokolov' }
        ]
      }
    }],
    ['dmitry@syntha.ai', {
    ...
    ['brand@syntha.ai', {
      ...
      profile: {
        ...
        organizations: [
          ...
          { organizationId: 'org-brand-002', roleInOrg: 'admin', permissions: { canViewFinances: true, canEditPLM: true, canManageTeam: true } }
        ],
        team: [
          { id: 'brand-001', firstName: 'Виктория', lastName: 'Белова', email: 'brand@syntha.ai', role: 'Creative Director', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop', nickname: 'viktoria_belova' },
          { id: 'brand-002', firstName: 'Артем', lastName: 'Новиков', email: 'artem@synthalab.com', role: 'Lead Designer', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', nickname: 'artem_novikov' }
        ]
      }
    }],
    ['artem@synthalab.com', {
    ...
    ['shop@syntha.ai', {
      ...
      profile: {
        ...
        team: [
          { id: 'shop-001', firstName: 'Ольга', lastName: 'Лебедева', email: 'shop@syntha.ai', role: 'Boutique Owner', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=400&fit=crop', nickname: 'olga_lebedeva' },
          { id: 'shop-002', firstName: 'Наталья', lastName: 'Котова', email: 'natalia@tsvetnoy.ru', role: 'Store Manager', avatar: 'https://images.unsplash.com/photo-1598550874175-4d0fe4a24424?w=400&h=400&fit=crop', nickname: 'natalia_kotova' }
        ]
      }
    }],
    ['natalia@tsvetnoy.ru', {
...
export class MockAuthRepository implements AuthRepository {
  ...
  async signIn(email: string, password: string): Promise<UserProfile> {
    ...
    if (!user || user.password !== password) {
      console.error('SignIn failed for:', email, 'Reason:', !user ? 'User not found' : 'Invalid password');
  ...
  async signUp(email: string, password: string, displayName: string): Promise<UserProfile> {
    ...
    const users = getUsers();
    if (users.has(email.toLowerCase())) throw new Error('Пользователь с таким email уже существует');
