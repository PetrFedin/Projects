...
export const RF_EGAIS_ALCOHOL_NAV_ADMIN: readonly NavSubsectionEntry[] = [
  ...
  },
  {
    ...
    detailsInventory: [['Справочники типов продукции и соответствие кодов для интеграций']],
  },
];
...
export const RF_EGAIS_ALCOHOL_NAV_BRAND: readonly NavSubsectionEntry[] = [
  ...
  },
  {
    ...
    detailsInventory: [['Документооборот заказов с учётом требований к алкогольной продукции']],
  },
  {
    label: 'Логистика',
    detailsBrief: ['Перемещения'],
    detailsInventory: [['Отгрузки и перемещения с передачей данных в контур ЕГАИС (интеграция)']],
  },
];
...
export const RF_EGAIS_ALCOHOL_NAV_SHOP: readonly NavSubsectionEntry[] = [
  ...
  },
  {
    label: 'Финансы',
    detailsBrief: ['Учёт'],
    detailsInventory: [['Финансовый учёт продаж подлежащих категорий']],
  },
  {
    label: 'Управление',
    detailsBrief: ['Лицензии', 'Доступ'],
    detailsInventory: [['Лицензии и ограничения по персоналу и точкам продаж']],
  },
];
...
export const RF_EGAIS_ALCOHOL_NAV_DISTRIBUTOR: readonly NavSubsectionEntry[] = [
  ...
  },
  {
    label: 'Заказы',
    detailsBrief: ['Опт'],
    detailsInventory: [['Заказы и отгрузки с корректной передачей в контур учёта']],
  },
];
...
export const RF_EGAIS_ALCOHOL_NAV_MANUFACTURER: readonly NavSubsectionEntry[] = [
  {
    ...
    detailsInventory: [[invCore('Учёт выпуска и партий для ЕГАИС на производстве')]],
  },
  {
    label: 'Производство',
    detailsBrief: ['Выпуск'],
    detailsInventory: [['Связка производственных операций с декларированием и перемещениями']],
  },
];
...
export const RF_EGAIS_ALCOHOL_NAV_SUPPLIER: readonly NavSubsectionEntry[] = [
  ...
  },
  {
    ...
    detailsInventory: [['Поставки сопутствующих материалов в контур лицензируемого производства']],
  },
];
