/**
 * Wave 27: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave27Persist,
  type Workshop2Wave27PersistField,
} from '@/lib/production/workshop2-wave27-cross-tab-audit';

export type Workshop2Wave27PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave27DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave27PersistResult> {
