/**
 * Wave 30: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave30Persist,
  type Workshop2Wave30PersistField,
} from '@/lib/production/workshop2-wave30-cross-tab-audit';

export type Workshop2Wave30PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave30DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave30PersistResult> {
