/**
 * Субъекты РФ для паспорта ТЗ: ISO 3166-2 (RU-…), краткие русские названия.
 * Источник кодов и имён — ISO 3166-2:RU (без спорных территорий вне перечня ISO).
 */
export type RfFederalSubjectOption = { iso31662: string; name: string };

const RF_FEDERAL_SUBJECT_RAW = `RU-ALT|Алтайский край
