/**
 * Wave 31: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  ...
  type Workshop2Wave31PersistField,
} from '@/lib/production/workshop2-wave31-cross-tab-audit';

export type Workshop2Wave31PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave31DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave31PersistResult> {
