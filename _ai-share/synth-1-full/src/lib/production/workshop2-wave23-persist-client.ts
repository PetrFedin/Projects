/**
 * Wave 23: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave23Persist,
  type Workshop2Wave23PersistField,
} from '@/lib/production/workshop2-wave23-cross-tab-audit';

export type Workshop2Wave23PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave23DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave23PersistResult> {
