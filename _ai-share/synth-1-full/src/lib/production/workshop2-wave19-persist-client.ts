/**
 * Wave 19: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave19Persist,
  type Workshop2Wave19PersistField,
} from '@/lib/production/workshop2-wave19-cross-tab-audit';

export type Workshop2Wave19PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave19DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave19PersistResult> {
