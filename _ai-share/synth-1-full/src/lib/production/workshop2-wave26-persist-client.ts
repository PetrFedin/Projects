/**
 * Wave 26: PUT досье + localStorage + cross-tab audit.
 */
...
import {
  ...
  type Workshop2Wave26PersistField,
} from '@/lib/production/workshop2-wave26-cross-tab-audit';

export type Workshop2Wave26PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave26DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave26PersistResult> {
