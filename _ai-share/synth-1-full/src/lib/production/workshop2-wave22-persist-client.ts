/**
 * Wave 22: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave22Persist,
  type Workshop2Wave22PersistField,
} from '@/lib/production/workshop2-wave22-cross-tab-audit';

export type Workshop2Wave22PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave22DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave22PersistResult> {
