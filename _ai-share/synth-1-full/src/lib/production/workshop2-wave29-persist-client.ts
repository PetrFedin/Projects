/**
 * Wave 29: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave29Persist,
  type Workshop2Wave29PersistField,
} from '@/lib/production/workshop2-wave29-cross-tab-audit';

export type Workshop2Wave29PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave29DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave29PersistResult> {
