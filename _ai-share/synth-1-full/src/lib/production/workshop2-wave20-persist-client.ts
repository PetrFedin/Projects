/**
 * Wave 20: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave20Persist,
  type Workshop2Wave20PersistField,
} from '@/lib/production/workshop2-wave20-cross-tab-audit';

export type Workshop2Wave20PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave20DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave20PersistResult> {
