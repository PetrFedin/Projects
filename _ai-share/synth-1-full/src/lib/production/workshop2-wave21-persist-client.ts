/**
 * Wave 21: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave21Persist,
  type Workshop2Wave21PersistField,
} from '@/lib/production/workshop2-wave21-cross-tab-audit';

export type Workshop2Wave21PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave21DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave21PersistResult> {
