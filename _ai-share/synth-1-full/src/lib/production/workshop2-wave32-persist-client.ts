/**
 * Wave 32: единый PUT досье + localStorage + cross-tab audit.
 */
...
import {
  auditWorkshop2Wave32Persist,
  type Workshop2Wave32PersistField,
} from '@/lib/production/workshop2-wave32-cross-tab-audit';

export type Workshop2Wave32PersistResult = {
  ok: boolean;
...
export async function putWorkshop2Wave32DossierPatch(input: {
  collectionId: string;
  articleId: string;
...
}): Promise<Workshop2Wave32PersistResult> {
