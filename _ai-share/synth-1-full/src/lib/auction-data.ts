...
export const mockAuctions: Auction[] = [
  {
    ...
    description:
      'Требуется пошив 500 единиц (жакеты, брюки) из высококачественного кашемира. Все лекала готовы. Срок отгрузки: 15 сентября.',
    ...
    bids: [
      {
        ...
        aiAnalysis: {
          ...
          summary:
            'Поставщик имеет высокий рейтинг и успешный опыт работы с аналогичными категориями. Цена ниже целевой на 7%.',
        },
      },
      {
        id: 'bid-2',
        ...
        aiAnalysis: {
          ...
          summary:
            'Сжатые сроки могут привести к задержке на 3-5 дней из-за текущей загруженности цеха пошива.',
        },
      },
    ],
  },
    ...
    bids: [
      {
        ...
        aiAnalysis: {
          ...
          summary:
            'Поставщик является проверенным партнером с прозрачной цепочкой поставок эко-материалов.',
        },
      },
    ],
  },
  {
    ...
    description:
      'Предлагаю создание серии Reels и Stories с обзором новой коллекции. Аудитория: ценители качества и минимализма. Полный анализ гардероба и стилизация луков.',
    ...
    aiSmartAdvisor: {
      relevanceScore: 96,
      matchAnalysis:
        'Идеально для сегмента Premium. Высокая концентрация целевой аудитории в Москве и СПБ. Стилистика инфлюенсера полностью совпадает с ДНК бренда.',
    },
    bids: [],
  },
  {
    ...
    description:
      'Размещение подробного лонгрида с фотографиями и ссылками в авторском Telegram-канале о моде. Охват одного поста более 45к просмотров.',
    ...
    aiSmartAdvisor: {
      relevanceScore: 89,
      matchAnalysis:
        'Отличный охват среди профессионального сообщества. Рекомендуется для B2B продвижения и повышения узнаваемости среди экспертов индустрии.',
    },
    bids: [],
  },
  {
    ...
    aiSmartAdvisor: {
      relevanceScore: 92,
      matchAnalysis:
        'Top photographers in your area are active. High ROI expected for this visual concept.',
    },
  },
];
