...
export const PRODUCTION_PERMISSIONS: Record<
  ProductionRole,
  {
...
export function getProductionRole(userRoles: string[] | undefined): ProductionRole {
  ...
  if (userRoles.includes('production_manager') || userRoles.includes('buyer'))
