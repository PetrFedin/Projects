...
export const MOCK_MATERIAL_LISTINGS: MaterialListing[] = [
  {
    ...
    originalPrice: 3500,
    condition: "pristine",
    description: "Остаток после пошива коллекции SS24. Шелк высшей категории, идеален для мелких серий или аксессуаров.",
    composition: "100% Silk",
    color: "Midnight Blue",
    hexColor: "#191970",
    images: ["https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=400&auto=format&fit=crop"],
  ...
  },
  {
    ...
    color: "Off-White",
    hexColor: "#F5F5F5",
    images: ["https://images.unsplash.com/photo-1574634534894-89d7576c8259?q=80&w=400&auto=format&fit=crop"],
  ...
  },
  {
    ...
    description: "Остатки раскроя джинсов. Ширина полосы 40-60см. Идеально для апсайклинга и пэчворка.",
    composition: "100% Cotton Selvedge Denim",
    color: "Raw Indigo",
    hexColor: "#1a237e",
    images: ["https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=400&auto=format&fit=crop"],
