...
export const MOCK_WAYPOINTS: ARWaypoint[] = [
  { id: 'w1', name: 'Вход', x: 50, y: 90, type: 'entrance' },
  {
    ...
    y: 70,
    type: 'promo',
    description: 'Лучшие образы сезона весна-лето',
  },
...
export const MOCK_ITEMS: ARDiscoveryItem[] = [
  {
    id: 'i1',
    name: 'Костюм "Tech Noir"',
    waypointId: 'w2',
    price: 24500,
    image: 'https://images.unsplash.com/photo-1594932224828-b4b059b6f6f5?q=80&w=200',
    isPromo: true,
    discount: '-15%',
  },
  {
    ...
    waypointId: 'w4',
    price: 12800,
    image: 'https://images.unsplash.com/photo-1584917033904-49033bb7a67b?q=80&w=200',
    isPromo: false,
  },
  {
    id: 'i3',
    name: 'Ботинки "Stellar"',
    waypointId: 'w4',
    price: 18200,
...
export const MOCK_ROUTES: ARRoute[] = [
  {
    id: 'r1',
    name: 'Быстрый шоппинг: Новинки',
    waypoints: [MOCK_WAYPOINTS[0], MOCK_WAYPOINTS[1], MOCK_WAYPOINTS[4]],
    estimatedTime: 480,
  },
  {
    id: 'r2',
    name: 'Полный обзор: Весь зал',
    waypoints: [
      MOCK_WAYPOINTS[0],
      MOCK_WAYPOINTS[1],
      MOCK_WAYPOINTS[5],
