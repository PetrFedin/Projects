...
export const MOCK_CUSTOMIZATION_PROJECTS: CustomizationProject[] = [
  {
    ...
    availableOptions: {
      fabrics: [
        ...
        },
        {
          ...
          priceDelta: 2000,
          image:
            'https://images.unsplash.com/photo-1574634534894-89d7576c8259?q=80&w=100&auto=format&fit=crop',
        },
        {
          id: 'f-003',
          name: 'Navy Cashmere',
          ...
          priceDelta: 1000,
          image:
            'https://images.unsplash.com/photo-1551488831-00ddcb6c6bd3?q=80&w=100&auto=format&fit=crop',
        },
      ],
      buttons: [
    ...
    image:
      'https://images.unsplash.com/photo-1591047139829-d91aec16adcd?q=80&w=800&auto=format&fit=crop',
  },
];
