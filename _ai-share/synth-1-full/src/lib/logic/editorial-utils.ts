...
export const MOCK_ARTICLES: EditorialArticle[] = [
  {
    ...
    status: 'published',
    mainImageUrl: 'https://images.unsplash.com/photo-1539109132304-39294f18639b?q=80&w=2070&auto=format&fit=crop', // Silver/Metallic fashion
    summary: 'Exploring the shift towards high-gloss materials in luxury fashion.',
    contentNodes: [
      { type: 'text', content: 'The upcoming SS26 season is defined by a bold return to futurism. Liquid-like metallics, ranging from molten silver to iridescent mercury-inspired fabrics, are dominating the high-fashion circuit.' },
      { type: 'image', content: { url: 'https://images.unsplash.com/photo-1581044777550-4cfa60707c33?q=80&w=1972&auto=format&fit=crop', caption: 'Futuristic silhouettes in high-gloss fabrics.' } },
      { type: 'quote', content: 'The metallic trend isn\'t just about surface shine; it\'s about the intersection of technology and artisanal craft.' }
    ],
  ...
  },
  {
    ...
    category: 'interview',
    status: 'published',
    mainImageUrl: 'https://images.unsplash.com/photo-1614850523296-d8c1af93d400?q=80&w=2070&auto=format&fit=crop', // Cyberpunk/Digital look
    summary: 'How digital twins are changing the physical design process.',
    contentNodes: [
      { type: 'text', content: 'Synth Lab is pushing the boundaries of what\'s possible in fashion design by using digital twins from the very first sketch.' }
    ],
  ...
  },
  {
    ...
    status: 'published',
    mainImageUrl: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=2070&auto=format&fit=crop', // Cotton/Natural look
...
export function getTrendingArticles(): EditorialArticle[] {
  return MOCK_ARTICLES.filter(a => a.status === 'published').sort((a, b) => b.viewCount - a.viewCount);
}
