...
export const HS_CODES: HSCode[] = [
  ...
  { code: '6201.12', description: 'Overcoats, raincoats, car coats, etc., of cotton', category: 'Outerwear' },
  { code: '6204.42', description: 'Dresses of cotton, not knitted', category: 'Dresses' },
  { code: '6403.51', description: 'Footwear with outer soles and uppers of leather', category: 'Footwear' },
  { code: '4202.21', description: 'Handbags with outer surface of leather', category: 'Accessories' }
];
