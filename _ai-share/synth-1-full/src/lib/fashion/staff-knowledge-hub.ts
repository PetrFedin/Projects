...
export function getStaffKnowledgePack(product: Product) {
  return {
    ...
    materialsDescription:
      'This high-density knit keeps shape through 50+ wash cycles. Perfect for travel collection.',
    stylingScript:
      'Suggest pairing with wide-leg trousers and silk scarves to elevate the look from casual to evening.',
