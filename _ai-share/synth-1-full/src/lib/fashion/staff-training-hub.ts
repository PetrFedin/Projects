...
export function getStaffTrainingPack(sku: string): StaffTrainingPackV1 {
  ...
  return {
    ...
    fabricBenefitRu: 'Ткань прошла обработку "антипиллинг", что предотвращает появление катышков даже после 50 стирок.',
    fitAdviceRu: 'Рекомендуйте брать свой размер для умеренного оверсайза или на размер меньше для более классической посадки.',
    comparisonWithCompetitorsRu: 'В отличие от масс-маркета, здесь используется гребенная пряжа, которая мягче и долговечнее.',
