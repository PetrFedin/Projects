...
const PAIRING_RULES: StylePairingRuleV1[] = [
  {
    id: 'r1',
    sourceCategory: 'Top',
    targetCategories: ['Bottom', 'Accessory'],
    styleMatch: ['minimalist', 'classicist'],
    boostFactor: 1.5,
  },
  {
    id: 'r2',
    sourceCategory: 'Outerwear',
    targetCategories: ['Accessory', 'Footwear'],
    styleMatch: ['streetwear', 'avant-garde'],
    boostFactor: 1.2,
  },
  {
    id: 'r3',
    sourceCategory: 'Dress',
    targetCategories: ['Footwear', 'Accessory'],
    styleMatch: ['bohemian'],
    boostFactor: 1.8,
  },
];
