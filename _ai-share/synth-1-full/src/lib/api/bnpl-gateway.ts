...
const MOCK_TX: BnplTransaction[] = [
  { id: 'tx1', orderId: 'ORD-8010', provider: 'tinkoff', amountRub: 45000, status: 'approved', createdAt: '2026-03-11T09:00:00Z', externalId: 'TINK-123' },
  { id: 'tx2', orderId: 'ORD-8011', provider: 'sber', amountRub: 28000, status: 'pending', createdAt: '2026-03-11T10:15:00Z' },
];
