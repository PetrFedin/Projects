...
const MOCK_ORDERS: TBYBOrder[] = [
  { id: 'tbyb1', orderId: 'TBYB-001', customerId: 'me', status: 'delivered', holdAmountRub: 15000, items: [{ sku: 'DRS-BLK-M', name: 'Платье', qty: 1 }], shippedAt: '2026-03-09T10:00:00Z', returnByDate: '2026-03-16', createdAt: '2026-03-08T12:00:00Z' },
  { id: 'tbyb2', orderId: 'TBYB-002', customerId: 'me', status: 'hold_placed', holdAmountRub: 22000, items: [{ sku: 'JKT-NAV', name: 'Пиджак', qty: 1 }, { sku: 'SHIRT-WHT', name: 'Рубашка', qty: 1 }], createdAt: '2026-03-11T09:00:00Z' },
];
