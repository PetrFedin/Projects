...
const MOCK_CAMPAIGNS: StyleMeCampaign[] = [
  { id: 'c1', name: 'Через 2 дня — образ под платье', daysAfterPurchase: 2, channel: 'telegram', status: 'active', createdAt: '2026-03-01T10:00:00Z' },
  { id: 'c2', name: 'Через 5 дней — аксессуары', daysAfterPurchase: 5, channel: 'whatsapp', status: 'draft', createdAt: '2026-03-05T12:00:00Z' },
];
