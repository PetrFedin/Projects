...
export default function OutletPage() {
  ...
  const [activeAudience, setActiveAudience] = useState<ProductAudience | 'Все' | 'Beauty' | 'Home'>('Все');
  ...
  return (
    <div className="container mx-auto px-4 py-4">
      <header className="mb-8 text-center">
        <h1 className="text-sm md:text-sm font-headline font-bold">Аутлет</h1>
       ...
       <Alert className="mb-8 bg-secondary">
          ...
          <AlertDescription>
            На товары из раздела "Аутлет" не распространяется действие бонусных баллов и других скидок программы лояльности.
          </AlertDescription>
        </Alert>
      ...
      <div className="grid lg:grid-cols-4 gap-3 items-start">
        ...
        <main className="lg:col-span-3">
          <div className="flex justify-between items-center mb-6">
             ...
             <div className="flex items-center gap-2">
                 <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" size="sm">Сортировать</Button>
                    </DropdownMenuTrigger>
           ...
           <div className={viewMode === 'grid' ? "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3" : "flex flex-col gap-3"}>
           ...
           {filteredProducts.length === 0 && !isLoading && (
            <div className="text-center py-4 border-2 border-dashed rounded-lg col-span-full">
                ...
                <Button variant="outline" onClick={resetFilters} className="mt-4">Сбросить фильтры</Button>
            </div>
           )}
            {isLoading && (
                 <div className={cn(
