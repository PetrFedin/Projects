      ...
      <div className="grid gap-3 md:grid-cols-4">
        {[
          ...
          },
          {
            ...
            value: `${savings.estimatedSavings.toLocaleString('ru-RU')} ₽`,
            icon: TrendingUp,
        ...
        <div className="space-y-6">
            ...
            <div className="relative space-y-4">
              ...
              <div className="space-y-1">
                <p className="text-base font-black tracking-tighter">
                  {savings.estimatedSavings.toLocaleString('ru-RU')} ₽
                </p>
                <p className="text-[10px] font-black uppercase tracking-widest text-white/50">
                  ОЦЕНКА ЭКОНОМИИ НА ЛОГИСТИКЕ (₽)
                </p>
              </div>
          ...
          <Card className="rounded-xl border-none p-4 shadow-xl shadow-slate-200/50">
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Ниже стоимость фрахта',
                  desc: 'Отдельные LCL-отправки обычно дороже совместной загрузки контейнера.',
                },
                {
                  title: 'Быстрее оформление',
                  desc: 'Объединённые партии часто проходят через агента приоритетнее.',
                },
                {
                  title: 'Меньше выбросов',
                  desc: 'Оптимизация загрузки снижает углеродный след поставок.',
                },
              ].map((benefit, i) => (
            ...
            <div className="mt-8 border-t border-slate-50 pt-8">
              ...
              >
                Подробнее о хабе <ExternalLink className="h-3.5 w-3.5" />
              </Button>
            </div>
          </Card>
        </div>
