    ...
    <div className="container max-w-6xl mx-auto px-4 py-6 space-y-6 pb-24">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Управление лимитами, отсрочками платежей и задолженностью байеров.</p>
        </div>
      </div>
          ...
          <Card key={id}>
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <CardDescription className="text-xs">Invoicing currency: {terms.currency}</CardDescription>
                </div>
                <div className="text-right">
                  <p className="text-[10px] text-muted-foreground uppercase font-bold">Credit Limit</p>
                  <p className="text-lg font-bold">{terms.creditLimit.toLocaleString()} {terms.currency}</p>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <Progress value={(terms.outstandingBalance / terms.creditLimit) * 100} className="h-2 bg-muted" />
              ...
              <div className="grid sm:grid-cols-2 gap-4 pt-2 border-t">
                ...
                <div className="flex items-center gap-3 p-3 rounded-lg border bg-muted/20">
                  ...
                  <div>
                    <p className="text-[10px] text-muted-foreground uppercase font-bold">Risk Status</p>
