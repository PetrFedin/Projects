    ...
    return (
        <div className="space-y-4">
             <header className="flex justify-between items-center">
                <div>
                    <h1 className="text-base font-bold font-headline">Справочник брендов</h1>
                    <p className="text-muted-foreground">Управление всеми брендами, представленными на платформе.</p>
                </div>
                 <Button>
                                    ...
                                    <TableRow key={brand.id}>
                                        <TableCell>
                                            <div className="flex items-center gap-3">
                                                <div className="relative w-10 h-10 rounded-md border p-1">
                                        ...
                                        <TableCell><Badge variant="outline" className="text-green-600 border-green-400">Активен</Badge></TableCell>
