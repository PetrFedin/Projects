        ...
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                <Button variant="outline" size="icon" asChild>
                    <Link href="/brand/media"><ChevronLeft className="h-4 w-4" /></Link>
                </Button>
                <h1 className="text-sm font-bold font-headline">Технические требования к видео</h1>
            </div>
             <Card>
                <CardHeader>
                    <CardTitle>Общие рекомендации</CardTitle>
                    <CardDescription>Следуйте этим правилам для оптимального отображения вашего контента на платформе.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
