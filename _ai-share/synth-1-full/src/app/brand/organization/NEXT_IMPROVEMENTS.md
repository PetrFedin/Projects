...
Рекомендуемый следующий шаг: углубление **п.6** (интеграции в module stats), **CRPT/outbox** для п.5, при желании добить **п.8** (таб-порядок / озвучка без дублей).
