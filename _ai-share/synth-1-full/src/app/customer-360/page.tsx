        ...
        <div className="container mx-auto px-4 py-4 space-y-4">
             <header className="flex flex-col sm:flex-row gap-3 justify-between sm:items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-base font-bold font-headline">Анна Новикова</h1>
                        <p className="text-muted-foreground">customer.id: <span className="font-mono">usr_12345abcde</span></p>
                    </div>
                </div>
