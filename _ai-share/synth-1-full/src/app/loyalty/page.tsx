...
function LotteryContent() {
    ...
    const brandWinners = [
        { nomination: 'Лучшие новички', winners: [{place: 1, name: 'Sacai', prize: 'Повышение (с PRO на Elite) на 3 мес.'}, {place: 2, name: 'Dries Van Noten', prize: 'Продление PRO на 1 мес.'}] },
        { nomination: 'Стабильные бренды', winners: [{place: 1, name: 'A.P.C.', prize: 'Повышение (с PRO на Elite) на 3 мес.'}, {place: 2, name: 'Issey Miyake', prize: 'Продление PRO на 1 мес.'}] },
        { nomination: 'Лучшие результаты', winners: [{place: 1, name: 'Jil Sander', prize: 'Продление Elite на 3 мес.'}, {place: 2, name: 'Acne Studios', prize: 'Продление PRO на 1 мес.'}] },
        { nomination: 'Самые популярные', winners: [{place: 1, name: 'Syntha', prize: 'Продление Elite на 3 мес.'}, {place: 2, name: 'Comme des Garçons', prize: 'Продление Elite на 1 мес.'}] },
        { nomination: 'Выбор Syntha', winners: [{place: 1, name: 'Maison Margiela', prize: 'Продление Elite на 3 мес.'}, {place: 2, name: 'Syntha', prize: 'Продление Elite на 1 мес.'}] },
    ];
                    ...
                    <CardContent className="space-y-6 flex-1">
                        <div>
                            ...
                            <ul className="list-disc pl-5 mt-2 text-sm text-muted-foreground space-y-1">
                                <li><b>Кто участвует:</b> Все чеки от покупок, а также самые активные пользователи платформы.</li>
                                <li><b>Призы:</b> Подписка на премиальные пакеты, начисление бонусных баллов, эксклюзивные призы от брендов.</li>
                                <li><b>Когда:</b> Каждый месяц.</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="font-semibold">Ежегодная новогодняя лотерея</h3>
                            <ul className="list-disc pl-5 mt-2 text-sm text-muted-foreground space-y-1">
                                <li><b>Кто участвует:</b> Все чеки от покупок, совершенных в течение года.</li>
                                <li><b>Призы:</b> Суперпризы от платформы Syntha и ведущих брендов.</li>
                            </ul>
                        </div>
                    </CardContent>
                     <CardFooter>
                         <div className="w-full space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button onClick={() => handleViewResults('clients')} disabled={!selectedClientDraw}>Посмотреть</Button>
                            </div>
                        </div>
                    </CardFooter>
                </Card>
                ...
                <Card className="h-full flex flex-col">
                    ...
                    <CardContent className="space-y-6 flex-1">
                        <div>
                            ...
                            <ul className="list-disc pl-5 mt-2 text-sm text-muted-foreground space-y-1">
                                <li><b>Приз:</b> 10 пакетов повышения тарифа или бесплатной пролонгации текущего.</li>
                                <li><b>Когда:</b> Каждые 6 месяцев.</li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="font-semibold">Номинации (каждые 3 месяца)</h3>
                            <ul className="list-disc pl-5 mt-2 text-sm text-muted-foreground space-y-1">
                                <li><b>Лучшие новички:</b> Для недавно присоединившихся партнеров.</li>
                                <li><b>Стабильные бренды:</b> За стабильно высокие показатели.</li>
                                <li><b>Лучшие результаты:</b> За наивысший рост продаж.</li>
                                <li><b>Самые популярные:</b> Бренды с наивысшим интересом от аудитории.</li>
                                <li><b>Выбор Syntha:</b> За самый эффективный результат.</li>
                            </ul>
                     ...
                     <CardFooter>
                         <div className="w-full space-y-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button onClick={() => handleViewResults('partners')} disabled={!selectedPartnerDraw}>Посмотреть</Button>
                            </div>
                        </div>
                    </CardFooter>
                </Card>
             ...
             <Dialog open={isResultsOpen} onOpenChange={setIsResultsOpen}>
                 <DialogContent className="sm:max-w-4xl">
                    ...
                    {viewingResultsFor === 'clients' && (
                        <div>
                            <h3 className="font-semibold mb-2">Победители среди клиентов</h3>
                            <Table>
                                <TableHeader>
                                    <TableRow>
                     ...
                     {viewingResultsFor === 'partners' && (
                        <Tabs defaultValue="brands">
                            ...
                            <TabsContent value="brands" className="pt-4">
                                <h3 className="font-semibold mb-2">Победители среди брендов</h3>
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                    ...
                                    <TableBody>
                                        {brandWinners.map(item => (
                                            <React.Fragment key={item.nomination}>
                                                <TableRow>
                                                    <TableCell rowSpan={2} className="font-medium align-middle">{item.nomination}</TableCell>
                                                    <TableCell><Badge variant="secondary">1. {item.winners[0].name}</Badge></TableCell>
                                                    <TableCell>{item.winners[0].prize}</TableCell>
                                                </TableRow>
                                                <TableRow>
                                                    <TableCell><Badge variant="outline">2. {item.winners[1].name}</Badge></TableCell>
                             ...
                             <TabsContent value="shops" className="pt-4">
                                <h3 className="font-semibold mb-2">Победители среди магазинов</h3>
                                <p className="text-sm text-muted-foreground">Результаты для магазинов будут объявлены в следующем розыгрыше.</p>
                            </TabsContent>
                        </Tabs>
                    )}
                 </DialogContent>
...
function GiftCardContent() {
    return (
        <Card>
            ...
            <CardContent>
                <p className="text-muted-foreground">Здесь вы сможете покупать и отправлять подарочные карты Syntha.</p>
            </CardContent>
        </Card>
    )
}
...
export default function LoyaltyPage() {
    ...
    return (
        <div className="bg-secondary/30 animate-in fade-in duration-300">
            <div className="container mx-auto px-4 py-4 md:py-24 space-y-6">
                <header className="text-center">
                    <h1 className="font-headline text-sm md:text-sm font-bold">Программа лояльности Syntha</h1>
                ...
                <Tabs defaultValue={defaultTab} className="w-full">
                    <TabsList className="grid w-full max-w-4xl mx-auto grid-cols-7 bg-white p-1 rounded-2xl shadow-sm">
                        <TabsTrigger value="clients"><Users className="mr-2 h-4 w-4"/>Для клиентов</TabsTrigger>
                        <TabsTrigger value="quests"><Target className="mr-2 h-4 w-4"/>Квесты</TabsTrigger>
                        <TabsTrigger value="marketplace"><ShoppingBag className="mr-2 h-4 w-4"/>Награды</TabsTrigger>
                        <TabsTrigger value="brands"><Store className="mr-2 h-4 w-4"/>Для брендов</TabsTrigger>
                        <TabsTrigger value="shops"><ShoppingCart className="mr-2 h-4 w-4"/>Для магазинов</TabsTrigger>
                        <TabsTrigger value="lottery"><Ticket className="mr-2 h-4 w-4"/>Лотерея</TabsTrigger>
                        <TabsTrigger value="gift_cards"><Gift className="mr-2 h-4 w-4"/>Подарочные карты</TabsTrigger>
                    </TabsList>
