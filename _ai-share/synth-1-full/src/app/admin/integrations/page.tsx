    ...
    <div className="container mx-auto px-4 py-12 space-y-6">
      <header className="flex flex-col md:flex-row justify-between md:items-start gap-3">
        <div className="flex-1">
          <h1 className="text-sm font-bold font-headline">Integration Hub</h1>
          ...
          <div className="grid md:grid-cols-2 gap-3">
             <Card>
                ...
                <CardContent className="space-y-4">
                   ...
                   <div className="flex justify-between items-center p-3 bg-blue-500/5 text-blue-600 rounded-lg">
             ...
             <Card>
                ...
                <CardContent className="space-y-4">
                   ...
                   <div className="flex justify-between items-center p-3 bg-green-500/5 text-green-600 rounded-lg">
          ...
          <Card>
             ...
             <CardContent>
                <Table>
                   ...
                   <TableBody>
                      <TableRow>
                         <TableCell className="text-xs text-muted-foreground">2025-03-08 14:22</TableCell>
                         <TableCell className="font-mono text-xs">TSH-BLK-M-001</TableCell>
                         <TableCell>
                            <Badge variant="outline" className="text-[10px]">B2B</Badge>
                            <span className="mx-1">→</span>
                            <Badge variant="outline" className="text-[10px] text-green-600">B2C</Badge>
                         </TableCell>
           ...
           <div className="grid md:grid-cols-3 gap-3">
              {['Wildberries', 'Ozon', 'Amazon'].map(mp => (
                 <Card key={mp}>
                    ...
                    <CardContent className="space-y-4">
                       <div className="text-sm font-black">2,410 <span className="text-xs font-normal text-muted-foreground">SKU active</span></div>
                       <p className="text-[10px] text-muted-foreground italic flex items-center gap-1">
                          <Zap className="w-3 h-3 text-amber-500" />
                          Последняя синхронизация: 5 мин. назад
                       </p>
                       <Button size="sm" variant="outline" className="w-full">Настройки API</Button>
                    </CardContent>
                 </Card>
              ))}
           </div>
           ...
           <Card className="border-amber-500/20 bg-amber-500/5">
              <CardContent className="p-4 flex items-start gap-3">
                 ...
                 <div className="space-y-1">
                    ...
                    <p className="text-xs text-amber-700">Некорректный токен доступа API. Автоматическая выгрузка стоков приостановлена.</p>
                 </div>
                 <Button size="sm" className="ml-auto bg-amber-500 hover:bg-amber-600">Обновить токен</Button>
              </CardContent>
           </Card>
        </TabsContent>
      </Tabs>
