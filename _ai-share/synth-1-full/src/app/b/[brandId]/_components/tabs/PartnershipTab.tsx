...
import { 
    ...
    Sparkles, Factory, Newspaper, Mail, Phone, BookText, Layers,
    ShieldCheck, Ruler, Image, Truck
} from 'lucide-react';
        ...
        <TabsContent value="partnership" className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pt-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                        ...
                        <CardContent className="p-4 space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            { label: 'Минимальный заказ (MOQ)', value: brand.b2b?.minOrderQuantity ? `от ${brand.b2b.minOrderQuantity} ед.` : 'от 10 ед. / 50к ₽' },
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 pt-4">
                                <Button 
                                    ...
                                    className="flex-1 h-10 rounded-xl font-black uppercase tracking-widest transition-all shadow-lg bg-black text-white hover:bg-black/90 shadow-black/20"
                                >
                                ...
                                <Button 
                                    ...
                                    variant="outline"
                                    className={cn(
                                        "flex-1 h-10 rounded-xl font-black uppercase tracking-widest transition-all",
                ...
                <div className="space-y-6">
                    <Card className="rounded-xl bg-muted/5 border border-muted/20 overflow-hidden shadow-sm">
                        <div className="p-4 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 group cursor-pointer">
                                    <div className="h-10 w-10 rounded-xl bg-accent/10 flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-all text-accent">
                                        <Mail className="h-5 w-5" />
                                    </div>
                                    <div>
                                        <p className="text-[9px] font-black text-muted-foreground uppercase">Email для предложений</p>
                                ...
                                <div className="flex items-center gap-3 group cursor-pointer">
                                    ...
                                    <div>
                                        <p className="text-[9px] font-black text-muted-foreground uppercase">Горячая линия B2B</p>
                            ...
                            <div className="space-y-4">
                                <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">B2B Документация</p>
                                <div className="grid grid-cols-1 gap-1">
                                    {[
                                        ...
                                        <Button key={i} variant="ghost" className="justify-start h-9 px-0 hover:text-accent hover:bg-transparent group">
                                            <doc.icon className="h-4 w-4 mr-3 text-accent group-hover:scale-110 transition-transform" />
