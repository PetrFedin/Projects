...
import { 
    X, ChevronLeft, ChevronRight, Quote, MessageSquare, 
    Instagram, Send 
} from 'lucide-react';
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl p-0 border-0 bg-transparent shadow-none">
                ...
                <DialogDescription className="sr-only">Информация о ключевых участниках команды и их роли в развитии бренда</DialogDescription>
