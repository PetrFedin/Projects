    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Здесь находятся товары, снятые с продажи или неактивные более 6 месяцев. Вы можете восстановить их в основной каталог для повторного согласования с брендом.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <Table>
