...
export default function B2BBudgetSeasonPage({ params: paramsPromise }: { params: Promise<{ season: string }> }) {
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    <Button variant="outline" size="icon" asChild>
                        <Link href="/shop/b2b/budget"><ChevronLeft className="h-4 w-4" /></Link>
                    </Button>
                    <div>
                                        ...
                                        <TableRow key={item.name}>
                                            ...
                                            <TableCell>
                                                <div className="flex flex-col gap-1 w-40">
                                                    ...
                                                    <p className="text-xs font-medium text-right">{budgetProgress.toFixed(1)}%</p>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <span className="cursor-help">{item.forecastRevenue.toLocaleString('ru-RU')} ₽</span>
                                                    </TooltipTrigger>
                                                    <TooltipContent>
