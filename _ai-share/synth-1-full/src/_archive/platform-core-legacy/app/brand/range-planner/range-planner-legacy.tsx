...
export function RangePlannerLegacyPage() {
  const [season, setSeason] = useState('SS2027');
    ...
    <CabinetPageContent maxWidth="5xl" className="space-y-6 pb-16">
      ...
      <div className="flex flex-wrap gap-2">
        <Button size="sm" asChild>
          <Link
            href={`${ROUTES.brand.productionWorkshop2}?${WORKSHOP2_COL_PARAM}=SS27&${WORKSHOP2_CREATE_PARAM}=1`}
          >
            <Sparkles className="mr-2 h-4 w-4" /> Создать артикул в Workshop2
          </Link>
        </Button>
