...
/** Legacy: Working Order — экспорт/импорт Excel, версии, сравнение с матрицей. */
...
export function ShopB2bWorkingOrderLegacyPage() {
  ...
  return (
    <ShopB2bNuOrderScope>
      <ShopB2bContentHeader
        ...
        lead="Экспорт заказа в Excel (размер/цвет/qty), правка офлайн, импорт обратно и версии."
      />
