        ...
        <div className="grid gap-3 lg:grid-cols-3">
            <Card className="lg:col-span-2">
             ...
             <div className="space-y-6">
                <Card>
                    <CardHeader>
                        <CardTitle className="text-sm flex items-center"><Smartphone className="mr-2 h-4 w-4"/>Устройства</CardTitle>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-sm flex items-center"><MapPin className="mr-2 h-4 w-4"/>Геоистория</CardTitle>
                    </CardHeader>
