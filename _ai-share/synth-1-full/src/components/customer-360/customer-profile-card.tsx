      ...
      <Card className="lg:col-span-2">
        ...
        <CardContent className="grid gap-3 sm:grid-cols-2">
          <div className="space-y-4">
            ...
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">ФИО:</strong>{' '}
              {profileData.personal.name}
            </p>
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Дата рождения:</strong>{' '}
              {profileData.personal.dob}
            </p>
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Пол:</strong>{' '}
              {profileData.personal.gender}
            </p>
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Город:</strong>{' '}
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Рост:</strong>{' '}
              {profileData.body.height}
            </p>
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Вес:</strong>{' '}
              {profileData.body.weight}
            </p>
            <p className="text-sm">
              <strong className="font-medium text-muted-foreground">Тип фигуры:</strong>{' '}
              {profileData.body.type}
            </p>
          </div>
          <div className="space-y-4 sm:col-span-2">
            ...
            <div className="flex flex-wrap gap-2">
              {profileData.interests.brands.map((b) => (
