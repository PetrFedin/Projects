        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="group relative">
              ...
              <input
                type="text"
                placeholder="Поиск: эстетика, настроение, технологии…"
                value={searchQuery}
            ...
            >
              ...
              <div className="relative flex gap-3">
                <Button className="h-12 flex-1 gap-3 rounded-xl bg-white text-[12px] font-black uppercase tracking-widest text-black shadow-2xl shadow-indigo-500/20 hover:bg-slate-200">
                  <ShoppingCart className="h-5 w-5" /> В образ
                </Button>
                <Button
                  variant="outline"
        ...
        <div className="flex items-center gap-3">
          <div className="hidden text-right md:block">
            ...
            <div className="mt-1 flex items-center gap-2">
              ...
              <span className="text-[10px] font-black tabular-nums text-indigo-400">42%</span>
            </div>
          </div>
