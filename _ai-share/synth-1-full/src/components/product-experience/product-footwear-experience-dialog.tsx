...
const Footwear360PairingModule = dynamic(
  ...
  {
    ssr: false,
    loading: () => <p className="py-6 text-sm text-muted-foreground">Загрузка 360°…</p>,
  }
);
      ...
      <DialogContent className="max-h-[94vh] max-w-4xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs leading-relaxed">
            Ракурсы из PIM (`Product.footwear`). Полная настройка скана и пресетов — в
            бренд-кабинете.
          </DialogDescription>
        </DialogHeader>
        ...
        {open ? (
          <Footwear360PairingModule bundle={exp.bundle} pairingPresets={exp.pairing} />
        ) : null}
      </DialogContent>
    </Dialog>
  );
