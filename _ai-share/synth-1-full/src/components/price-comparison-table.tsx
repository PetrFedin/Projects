                ...
                <TableRow key={offer.platform}>
                  <TableCell>
                    <div className="flex items-center gap-3">
                       <div className="relative h-8 w-8 rounded-full overflow-hidden bg-muted flex items-center justify-center">
                         <Image src={offer.logoUrl} alt={offer.platform} width={20} height={20} className="object-contain" />
                       </div>
                       <div>
                  ...
                  <TableCell>
                    <div className="flex items-baseline gap-2">
                        ...
                        {offer.originalPrice && (
                            <p className="text-sm text-muted-foreground line-through">{offer.originalPrice.toLocaleString('ru-RU')} ₽</p>
                        )}
                    </div>
                  </TableCell>
                  <TableCell className="text-right">
                    <a href={offer.url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-accent hover:underline">
