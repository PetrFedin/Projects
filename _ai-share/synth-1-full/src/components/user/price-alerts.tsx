          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">Всего отслеживаний</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">Активных</p>
              </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-muted-foreground">Сработало</p>
              </div>
          ...
          <Tabs value={filter} onValueChange={(v) => setFilter(v as any)}>
            ...
            {filteredAlerts.length === 0 ? (
              <div className="py-12 text-center text-muted-foreground">
                ...
                <p>{alerts.length === 0 ? 'Нет отслеживаемых товаров' : 'Ничего не найдено'}</p>
...
function AlertCard({
  ...
  return (
    <Card
      className={cn('transition-all', alert.notifiedAt && 'border-green-500/20 bg-green-500/5')}
    >
      <CardContent className="pt-6">
            ...
            <div className="relative h-20 w-20 overflow-hidden rounded-lg border">
              ...
              {hasDiscount && (
                <div className="absolute right-2 top-2">
                  <Badge className="bg-red-500 text-white">-{alert.discount}%</Badge>
                </div>
              )}
            </div>
          </Link>
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-2 flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Switch checked={alert.isActive} onCheckedChange={() => onToggle(alert.id)} />
            ...
            <div className="flex items-center justify-between border-t pt-3 text-xs text-muted-foreground">
              <span>Отслеживается с {format(alert.createdAt, 'd MMM yyyy', { locale: ru })}</span>
              {alert.notifiedAt && (
                <span>
