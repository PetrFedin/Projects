...
import { TrendingUp, TrendingDown, DollarSign, ShoppingBag, Calendar, PieChart, BarChart3, Target } from 'lucide-react';
...
export default function AdvancedAnalytics() {
    ...
    return (
      <Card>
        <CardContent className="pt-6">
          <div className="text-center py-4">Загрузка аналитики...</div>
        </CardContent>
      </Card>
    );
  }
  ...
  const avgMonthly = monthlyStats.reduce((sum, m) => sum + m.total, 0) / Math.max(1, monthlyStats.length);
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">Тренд</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="spending" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Динамика ваших покупок за последние 6 месяцев
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="projections" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI анализирует ваши расходы и дает рекомендации
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="p-4 rounded-lg bg-muted">
                  ...
                  <p className="text-sm font-bold">{Math.round(projectedYearly).toLocaleString('ru-RU')} ₽</p>
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-sm">Рекомендации AI:</h4>
                  <div className="space-y-2">
                    <div className="p-3 rounded-lg border bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
                      <p className="text-sm font-medium mb-1">Оптимизация бюджета</p>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 rounded-lg border bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-800">
                      <p className="text-sm font-medium mb-1">Сезонные покупки</p>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 rounded-lg border bg-purple-50 dark:bg-purple-950/20 border-purple-200 dark:border-purple-800">
                      <p className="text-sm font-medium mb-1">Используйте бонусы</p>
                      <p className="text-xs text-muted-foreground">
                        У вас накоплено {user?.loyaltyPoints || 0} баллов. Используйте их для следующей покупки!
                      </p>
                    </div>
                  </div>
                </div>
