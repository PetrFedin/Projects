        ...
        <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {materials.map(material => (
                    <div key={material.name} className="group relative rounded-lg overflow-hidden">
                        <div className="relative aspect-[4/3]">
                            <Image src={material.imageUrl} alt={material.name} fill className="object-cover group-hover:scale-105 transition-transform duration-300" />
