      ...
      <div className="flex flex-wrap items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-1">
          <h2 className="text-text-primary text-sm font-semibold">
            Таможня после образца (каталог)
          </h2>
          <p className="text-text-secondary text-xs leading-snug">
            Дополнительные коды ТН ВЭД, черновик до согласования, обоснование классификации и
            декларация HS не нужны цеху до раскроя — убраны из карточки артикула. Финальный пакет
            (код под отгрузку, ОКПД2, ТР, маркировка…) закрывается на вкладке артикула «Склад» в
            блоке приёмки сэмпла.
          </p>
        </div>
      </div>
      <Workshop2DossierSectionRows
