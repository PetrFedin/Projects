...
export const MAX_VISUAL_REF_IMAGE_DATA_URL_CHARS = 900_000;
export const MAX_VISUAL_REF_VIDEO_DATA_URL_CHARS = 5_000_000;
/** Референсы модели в ТЗ: до 6 файлов; сетка по умолчанию компактная (5 колонок). */
