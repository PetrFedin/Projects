...
import { SKETCH_SHEET_VIEW_LABELS, DEFAULT_MASTER_PIN_SNIPPETS } from '@/lib/production/workshop2-sketch-sheets';
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1 space-y-2">
                          ...
                          >
                            ...
                            <Checkbox
                              ...
                              onCheckedChange={() =>
                                ...
                                toggleDeferAttribute(W2_CONSTRUCTION_SKETCHES_DEFER_ID)
                    ...
                    <p className="text-text-secondary text-[11px] leading-snug">
                      Подложка и метки на изделие для цеха: загрузите скетч, расставьте точки и привяжите их к полям ТЗ.
                    </p>
                    ...
                    <TabsList className="inline-flex h-9 min-h-9 w-full min-w-0 max-w-none shrink-0 gap-1 rounded-lg border border-input bg-background p-0.5 shadow-sm sm:w-auto">
                      ...
                      <TabsTrigger
                        ...
                        className={cn(
                          ...
                          'data-[state=active]:border-border-default data-[state=active]:bg-white data-[state=active]:text-text-primary data-[state=active]:shadow-sm'
                        ...
                        <span className="flex flex-nowrap items-center justify-center gap-1">
                          ...
                          {(() => {
                            ...
                            const masterBoard =
                              ...
                              Boolean(dossier.categorySketchImageDataUrl?.trim()) ? 1 : 0;
                    ...
                    {sketchWorkspaceTab === 'sketch' ? (
                      ...
                      <div className="flex h-9 min-h-9 w-full min-w-0 flex-nowrap items-center justify-end gap-2 sm:w-auto sm:flex-1 sm:justify-end sm:pl-1">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="h-9 shrink-0 gap-1.5 text-xs border-slate-200 text-slate-500"
                          disabled={true}
                  ...
                  <TabsContent value="sketch" className="mt-0 outline-none focus-visible:ring-0">
                    ...
                    >
                      ...
                      <div id="w2-visuals-sketch-templates" className="scroll-mt-24">
                        ...
                        {WORKSHOP2_MASTER_SKETCH_PIN_TEMPLATES_UI_ENABLED ? (
                            ...
                            <details className="mb-3 rounded-lg border border-border-default bg-bg-surface2/50 shadow-sm">
                    ...
                    {normalizedSketchSheets.length > 0 ? (
                      ...
                      <CategorySketchSheetsBlock
                        ...
                        sketchToolbarEditorRef={sketchSheetAnnotatorRef as Ref<CategorySketchAnnotatorHandle>}
