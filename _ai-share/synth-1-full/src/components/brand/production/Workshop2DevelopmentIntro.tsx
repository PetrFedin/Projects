  ...
  return (
    ...
    >
      <p className="text-text-primary font-semibold">
        Разработка: от артикула до образца и шоурума
      </p>
      <p className="text-text-muted mt-1 text-[11px]">
        Заведите артикул и пройдите ТЗ и согласования до эталона. В списке коллекции мини-шкала
        этапов идёт слева направо: сначала разработка и ТЗ, затем сэмплы и выпуск по каталогу.
        Серия, крупные объёмы и опт — в поле цеха и в B2B, не в этом разделе.
      </p>
      ...
      <p className="text-text-muted mt-2 text-[10px] leading-snug">
        В полной матрице коллекции между ТЗ и снабжением есть этап согласования всех сторон
        (gate-all-stakeholders) — здесь он не вынесен отдельной вкладкой: статусы и подписи
        закрывают это внутри «Обзор» и «ТЗ». Правая часть шкалы (от якоря supply-path в каталоге,
        далее samples и выпуск) соответствует вкладкам «Снабжение» и далее в карточке артикула.
      </p>
    </div>
  );
}
