...
import { getProductionStageDisplayMode, type ProductionFlowProfileId } from '@/lib/production/collection-production-profiles';
import {
...
import { DEPS_SCHEMA_CHUNK, statusLabel, type StagesTabArticle } from '@/components/brand/production/stages-dependencies-tab-content-helpers';
import {
  StagesHelpHover,
...
export function Workshop2StagesDependenciesProcessTab(props: Workshop2StagesDependenciesProcessTabProps) {
  const {
    depsPinned,
    onDepsPinnedChange,
    depsOpen,
