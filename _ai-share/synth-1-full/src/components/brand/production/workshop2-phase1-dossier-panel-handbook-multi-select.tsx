...
export type HandbookMultiSelectOption = { parameterId: string; label: string };
export type HandbookMultiSelectPart = { parameterId: string; displayLabel: string };

/** Выпадающий список с чекбоксами (несколько значений справочника). */
export function HandbookMultiSelectPopover({
  options,
  parts,
  onPartsChange,
  className,
  ...
  options: HandbookMultiSelectOption[];
  parts: HandbookMultiSelectPart[];
  onPartsChange: (next: HandbookMultiSelectPart[]) => void;
  className?: string;
