                ...
                <div className="h-[250px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                         <FunnelChart layout="vertical">
                            <Tooltip formatter={(value, name) => [typeof value === 'number' ? value.toLocaleString('ru-RU') : value, name]}/>
                            <Funnel
                                dataKey="value"
                            ...
                            >
                                <LabelList 
                                    ...
                                    formatter={(label: string, props: any[]) => {
                                        ...
                                        if (conversion === undefined || conversion === 100) return `${label}: ${formattedValue}`;
