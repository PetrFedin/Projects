    ...
    <div className="grid gap-8 md:grid-cols-3">
      <div className="md:col-span-2">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                <div className="relative size-20 rounded-md border bg-muted/30 p-1">
                  <Image
                    src={brand.logo.url}
                    alt={brand.logo.alt}
                    fill
          ...
          <CardFooter>
            <Button onClick={handleSaveChanges} disabled={isSaving} type="button">
      ...
      <div className="md:col-span-1">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Так ваша карточка будет выглядеть в каталоге брендов.</CardDescription>
          </CardHeader>
          <CardContent>
