            ...
            <TableBody>
                {products.map((product) => {
                    ...
                    <TableRow key={product.id} data-promoted={product.isPromoted}>
                        ...
                        <TableCell>
                            <Badge variant={availability.status === 'in_stock' ? "outline" : "secondary"} className={availability.status === 'in_stock' ? "text-green-600 border-green-600" : ""}>{availability.text}</Badge>
                        </TableCell>
