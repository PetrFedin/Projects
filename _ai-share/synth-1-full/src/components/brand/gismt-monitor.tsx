        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="group relative overflow-hidden rounded-none border border-slate-100 bg-slate-50 p-4">
              ...
              <ScanBarcode className="absolute -bottom-2 -right-2 h-12 w-12 text-slate-200 opacity-50 transition-transform group-hover:scale-110" />
            </div>
            <div className="group relative overflow-hidden rounded-none border border-slate-100 bg-slate-50 p-4">
              <p className="mb-1 text-[9px] font-black uppercase text-slate-400">
                Баланс кодов (ЦРПТ)
              ...
              <div className="flex items-end gap-2">
                <h4 className="text-sm font-black tabular-nums text-slate-900">48,000</h4>
                <span className="mb-1 text-[10px] font-black uppercase tracking-tighter text-indigo-600">
                  ₽
                </span>
              </div>
