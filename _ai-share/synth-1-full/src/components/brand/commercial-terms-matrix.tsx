...
=======
            <div className="bg-bg-surface2 border-border-subtle hover:border-accent-primary/30 group flex flex-col justify-between rounded-xl border p-4 transition-all">
              <div>
                <div className="mb-4 flex items-center gap-3">
                  <BadgePercent className="text-accent-primary h-6 w-6" />
...
=======
                    ...
                    >
                      <div>
                        <span className="text-text-muted block text-[10px] font-black uppercase">
                          {t.label}
                        </span>
...
=======
                  <div className="bg-accent-primary/10 border-accent-primary/20 flex items-center gap-3 rounded-2xl border p-4">
                    ...
                    <div>
                      <p className="text-accent-primary text-[10px] font-black uppercase leading-tight">
                        Escrow Contracts
                      </p>
...
=======
                  ...
                  <Input
                    placeholder="Поиск партнера..."
                    className="border-border-subtle h-10 w-64 rounded-xl pl-9 text-[10px] font-bold uppercase"
                  />
                </div>
            ...
            <div className="border-border-subtle overflow-hidden rounded-xl border shadow-sm">
              <Table>
                <TableHeader className="bg-bg-surface2">
                  <TableRow className="border-none">
                    <TableHead className="text-text-secondary px-8 py-5 text-[10px] font-black uppercase tracking-widest">
                      Партнер / Тип
                    </TableHead>
                    <TableHead className="text-text-secondary py-5 text-[10px] font-black uppercase tracking-widest">
                      Tier / Скидка
                    </TableHead>
                    <TableHead className="text-text-secondary py-5 text-[10px] font-black uppercase tracking-widest">
                      Условия оплаты
...
=======
                      ...
                      <TableCell className="text-text-primary text-[10px] font-black uppercase italic tracking-tighter">
                        {p.payment}
                      </TableCell>
