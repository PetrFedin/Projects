...
const dnaData = [
  ...
  { parameter: 'Ценностный профиль', value: 'Innovation: 60%, Sustainability: 25%, Comfort: 15%' },
  {
    parameter: 'AI-резюме',
    value:
      'Syntha — это технологичный бренд, объединяющий минимализм и функциональность для современных горожан.',
  },
];
...
const visualData = [
  ...
  {
    parameter: 'Material Distribution',
    value: 'Тех. ткани: 40%, Шерсть: 30%, Хлопок: 20%, Кожа: 10%',
  },
  { parameter: 'Product Complexity', value: 'Средний (4 SKU/коллекция, 2-3 цвета)' },
  {
    parameter: 'Innovation Index',
    value: 'Высокий (уникальные лекала, интеграция tech-элементов)',
  },
];
      ...
      <DialogContent className="flex h-[90vh] max-w-4xl flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-sm font-bold">
            <BrainCircuit /> AI-анализ бренда "Syntha"
          </DialogTitle>
          <DialogDescription>
            Этот отчет сгенерирован автоматически на основе данных о коллекциях, продажах, отзывах и
            контенте бренда.
          </DialogDescription>
        </DialogHeader>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">
                    1. Брендовая идентичность (AI Brand DNA)
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <Table>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    На основе текущих трендов и данных о похожих товарах, AI прогнозирует высокий
                    спрос на категорию "Верхняя одежда" и "Аксессуары" в следующем сезоне.
                    Рекомендуется увеличить производство свитеров на 15%.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    AI определил бренды A.P.C. и Jil Sander как наиболее близкие по стилю и
                    аудитории, что указывает на высокий потенциал успешной коллаборации.
                  </p>
                </CardContent>
              </Card>
            </div>
