        ...
        return (
          <div>
            <DialogTitle className="text-sm font-bold">
              Результаты теста для "{product.name}"
            </DialogTitle>
            <DialogDescription className="mt-2">
              Тест завершен. Вариант Б показал лучшие результаты.
            </DialogDescription>
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Card>
                <CardContent className="p-4">
                  <p className="text-sm font-medium text-muted-foreground">Вариант A (Контроль)</p>
                  <div className="relative mt-2 aspect-[4/5] w-full overflow-hidden rounded-md bg-muted">
                    <Image
                  ...
                  <div className="mt-4 space-y-2 text-sm">
                    <p>
                      CTR: <span className="font-semibold">3.2%</span>
                    </p>
                    <p>
                      Добавлений в корзину: <span className="font-semibold">1,204</span>
                    </p>
                  </div>
                </CardContent>
              </Card>
        ...
        return (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Мы собираем данные. Вы можете закрыть это окно, результаты появятся здесь по
                завершении.
              </DialogDescription>
            </DialogHeader>
            <div className="py-12 text-center">
              ...
              <Progress value={progress} className="mx-auto mt-4 w-full max-w-sm" />
            </div>
            <DialogFooter>
        ...
        return (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Загрузите альтернативное изображение, чтобы начать тест и сравнить его эффективность
                с текущим.
              </DialogDescription>
            </DialogHeader>
            <div className="mt-4 grid grid-cols-2 gap-3">
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="relative mt-2 flex aspect-[4/5] w-full items-center justify-center overflow-hidden rounded-md border-2 border-dashed bg-muted">
                    {variantBImage ? (
                      <Image
                        src={variantBImage}
                        alt="Вариант B"
                      ...
                      <label
                        htmlFor="upload-b"
                        className="cursor-pointer p-4 text-center text-muted-foreground"
                      >
