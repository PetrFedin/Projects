...
export function ParameterGroupsDialog({ isOpen, onOpenChange, parameters }: ParameterGroupsDialogProps) {
                            ...
                            <Card key={groupName}>
                                ...
                                <CardContent>
                                    <ul className="space-y-2 text-sm">
                                        {params.map(p => (
                                            <li key={p.id}>
                                                <span className="font-mono font-semibold w-8 inline-block">{p.id}</span>
