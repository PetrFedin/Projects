...
const fitPhilosophyData = [
    { subcategory: 'Офисные рубашки (Tailored)', philosophy: 'Структурированные, строгая линия плеч', features: 'Ease по груди 4–6 см; по талии 2–4 см; вытачки формируют приталенный силуэт' },
    { subcategory: 'Oversize / Relaxed fit', philosophy: 'Свободная посадка, удлинённая спинка', features: 'Ease 8–14 см; спущенное плечо; длина 70–80 см' },
    { subcategory: 'Casual (linen, cotton)', philosophy: 'Натуральные ткани, расслабленный крой', features: 'Ease 6–10 см; мягкая линия плеч; допускается асимметрия' },
    { subcategory: 'Шёлковые и вечерние блузы', philosophy: 'Мягкое драпирование, лёгкий оверсайз', features: 'Ease 8–12 см; узкая пройма, прибавка к длине изделия +3 см' },
    { subcategory: 'Блузы с объёмным рукавом', philosophy: 'Акцент на рукав и пройму', features: 'Обхват руки +4–6 см; ease по груди 8–10 см' },
    { subcategory: 'Plus Size Fit', philosophy: 'Увеличенная свобода, баланс верхней части тела', features: 'Ease по груди 10–14 см, талия 8–12 см; пройма +2 см; плечи шире на +1,5 см' },
];
...
const practicalCommentsData = [
    { indicator: 'Ease по груди', recommendation: 'Прибавка 6–8 см — универсальный баланс между офисным и casual' },
    { indicator: 'Рукав и плечо', recommendation: 'Контролировать баланс: у итальянских — узкое плечо, у французских — узкая пройма' },
    { indicator: 'Пройма', recommendation: 'Для Plus Size — +2–3 см по глубине; критична для комфорта' },
    { indicator: 'Талия', recommendation: 'У офисных моделей — вытачки, у casual — свободный силуэт' },
    { indicator: 'Ткани', recommendation: 'Хлопок и лён требуют ease +2 см, шёлк и вискоза — минус ease (за счёт драпировки)' },
];


export function FitGuideShirtsDialog({ isOpen, onOpenChange, audience = 'women' }: FitGuideShirtsDialogProps) {
     if (audience === 'men') {
        return (
