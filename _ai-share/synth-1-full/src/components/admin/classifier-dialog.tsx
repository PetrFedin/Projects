...
export function ClassifierDialog({ isOpen, onOpenChange, classificationData }: ClassifierDialogProps) {
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl h-[80vh] flex flex-col">
                 <DialogHeader>
                    ...
                    <DialogDescription>
                        Матрица для сегментации брендов по стилю, ценностям и позиционированию. Эта модель используется для обучения AI, рекомендательных систем и аналитических отчетов.
                    </DialogDescription>
                </DialogHeader>
