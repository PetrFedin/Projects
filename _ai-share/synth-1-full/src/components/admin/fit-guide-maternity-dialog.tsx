...
const constructionFeaturesData = [
    ...
    { zone: 'Под грудью', rtw: 'базовая', maternityFit: '+4–6', comment: 'изменение рёберного объёма' },
    { zone: 'Талия (живот)', rtw: '—', maternityFit: '+12–26', comment: 'ткань с драпировкой, jersey insert' },
    ...
    { zone: 'Ease (свобода)', rtw: '4–6', maternityFit: '10–16', comment: 'мягкий трикотаж, jersey knit' },
];

const categoryExplanationData = [
    { subcategory: 'Платья и сарафаны для беременных', philosophy: 'Empire / A-line', features: 'высокая талия, драпировка, резинка по спинке' },
    { subcategory: 'Блузы и туники', philosophy: 'Relaxed top', features: 'складки под грудью, пуговицы для кормления' },
    { subcategory: 'Брюки и леггинсы maternity', philosophy: 'Stretch band', features: 'высокая вставка jersey на живот, удлинённая спина' },
    { subcategory: 'Худи, свитшоты, домашние костюмы', philosophy: 'Adaptive comfort', features: 'extra-length переда, заниженная линия талии' },
    { subcategory: 'Нижнее бельё и пижамы для беременных', philosophy: 'Seamless / nursing', features: 'мягкие чашки без косточек, feeding-access' },
];
            ...
            <DialogContent className="max-w-6xl h-[90vh]">
                ...
                <ScrollArea className="flex-1 -mx-6">
                    <div className="px-6 space-y-4">
                        <Card>
                             <CardHeader><CardTitle>📏 Особенности конструкции</CardTitle></CardHeader>
                             <CardContent>
                                <Table>
                                    <TableHeader>
                                        <TableRow>
