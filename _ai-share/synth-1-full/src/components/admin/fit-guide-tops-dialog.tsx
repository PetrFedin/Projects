...
const fitPhilosophyData = [
    { subcategory: 'Basic (базовые футболки)', philosophy: 'Минимум ease, прилегающий силуэт', features: 'Прибавка по груди 4–6 см; длина 55–60 см; эластичные ткани' },
    { subcategory: 'Graphic / Oversize', philosophy: 'Свободный силуэт, удлинённая спинка', features: 'Ease 10–16 см; плечо спущено на 2–3 см; длина 65–75 см' },
    { subcategory: 'Polo', philosophy: 'Структурированный верх, умеренная приталенность', features: 'Ease 6–8 см; длина до бедра; воротник с планкой' },
    { subcategory: 'Майки (Tank / Ribbed)', philosophy: 'Минимальный ease, акцент на фигуру', features: 'Прибавка 2–4 см; stretch 5–10%; длина 50–55 см' },
    { subcategory: 'Кроп-топы (Crop Tops)', philosophy: 'Укороченный торс, плотный фит', features: 'Ease 0–2 см; высота до талии; ткань — эластан, рибана' },
    { subcategory: 'Plus Size Fit', philosophy: 'Комфортная посадка, свободное плечо', features: 'Ease по груди 10–14 см, по талии 8–12 см; длина увеличена на +3–5 см' },
];
...
const easeAllowanceData = [
    ...
    { zone: 'Пройма', rtw: '+0,5', plusSize: '+1,5', note: 'У моделей с рукавом-реглан или безрукавок — var.' },
    { zone: 'Рукав / Обхват руки', rtw: '+1', plusSize: '+2–3', note: 'Для короткого рукава — допуск по эластичности' },
    { zone: 'Длина изделия', rtw: '50–70', plusSize: '55–80', note: 'Зависит от типа (basic, oversize, crop)' },
];
...
const practicalCommentsData = [
    ...
    { indicator: 'Длина изделия', recommendation: 'Контролировать визуальный баланс с талием и брюками — при росте 170 см идеал 60–63 см' },
    { indicator: 'Stretch', recommendation: 'При >8% эластана — уменьшить прибавку по груди на 2–3 см' },
    { indicator: 'Плечо и рукав', recommendation: 'При оверсайзе важно соблюдать баланс: спущенное плечо, но без провала в груди' },
    { indicator: 'Ткань', recommendation: 'Хлопок — структурный, лён — требует ease +2 см, вискоза — минус 1–2 см' },
];


export function FitGuideTopsDialog({ isOpen, onOpenChange, audience = 'women' }: FitGuideTopsDialogProps) {
     if (audience === 'men') {
        return (
