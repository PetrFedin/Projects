...
const fitPhilosophyData = [
    { subcategory: 'Купальники (One-piece)', philosophy: 'Комфорт + поддержка груди', features: 'Компрессионный материал; грудная зона с формованной вставкой; подгрудная резинка' },
    { subcategory: 'Бикини / Танккини', philosophy: 'Раздельный fit по зонам', features: 'Верх — по обхвату груди, низ — по бёдрам и rise; stretch 15–25%' },
    { subcategory: 'Плавки / Шорты', philosophy: 'Функциональный низ', features: 'Высота посадки варьируется: low 17–19 см, high 22–25 см' },
    { subcategory: 'Пляжные платья / Туники', philosophy: 'Relaxed fit', features: 'Ease по груди 10–18 см; длина 80–120 см' },
    { subcategory: 'Парео / Сарафаны', philosophy: 'Свободная драпировка', features: 'Безразмерная, регулируемая посадка' },
    { subcategory: 'Plus Size Fit', philosophy: 'Расширенная зона груди и талии', features: 'Высокий rise; более плотная ткань; удлинённая линия торса' },
];

const easeAllowanceData = [
    { zone: 'Грудь', rtw: '0–4', plusSize: '4–8', note: 'В купальниках компрессионный эффект, допускается отрицательный ease' },
    ...
    { zone: 'Высота бедра', rtw: '20–35', plusSize: '25–38', note: 'Чем выше cut, тем визуально стройнее силуэт' },
    { zone: 'Rise', rtw: '17–25', plusSize: '20–30', note: 'Влияет на фиксацию по талии' },
    { zone: 'Длина туники / платья', rtw: '80–120', plusSize: '90–130', note: 'У Plus выше ease и драпировка по бокам' },
];
...
const practicalCommentsData = [
    { indicator: 'Stretch ткани (купальный полиамид/спандекс)', recommendation: '20–35% — оптимум для RTW; 25–40% — для Plus' },
    ...
    { indicator: 'Поддержка груди', recommendation: 'Встроенные чашки или резинка; у Plus — усиленные боковые панели' },
    { indicator: 'Высота бедра (high cut)', recommendation: 'Повышает визуальное удлинение ног на 2–3 см пропорционально росту' },
    { indicator: 'Ease по талии', recommendation: 'У shapewear моделей — отрицательный (−2…−6 см)' },
    { indicator: 'Ease по бёдрам', recommendation: 'RTW 2–6 см / Plus 6–12 см; адаптация под растяжимость ткани' },
    { indicator: 'Ткань', recommendation: 'Полиамид + эластан (LYCRA®), с УФ-защитой 50+, формоустойчивая структура' },
];
                ...
                <ScrollArea className="flex-1 -mx-6">
                    <div className="px-6 space-y-4">
                        ...
                        <Card>
                         ...
                         <Card>
                             <CardHeader><CardTitle>🔠 Буквенная шкала (Alpha) для пляжной одежды</CardTitle></CardHeader>
                             <CardContent>
                                <Table>
                                    <TableHeader>
                                        <TableRow>
