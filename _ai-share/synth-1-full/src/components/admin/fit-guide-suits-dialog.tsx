...
const fitPhilosophyData = [
  { subcategory: 'Жакет (Blazer)', philosophy: 'Структурированный, подчёркивает линию плеч и талию', features: 'Ease по груди 4–6 см; по талии 2–4 см; спинка с вытачками; длина 60–65 см' },
  { subcategory: 'Костюм (Suit)', philosophy: 'Комплект жакет + брюки/юбка; классический баланс', features: 'Ease по груди 6–8 см; по талии 4–6 см; плечо формованное; пройма узкая' },
  { subcategory: 'Смокинг / фрак', philosophy: 'Вечерняя категория с акцентом на силуэт', features: 'Ease минимальный (4–5 см по груди); длина жакета увеличена на +5 см к RTW' },
  { subcategory: 'Блейзер оверсайз', philosophy: 'Современный силуэт, расслабленный fit', features: 'Ease 10–12 см по груди, 8 см по талии; спущенное плечо на 1,5–2 см' },
  { subcategory: 'Plus Size блейзер', philosophy: 'Комфортная пройма, мягкое плечо', features: 'Увеличена глубина проймы (+2 см); ease по груди 8–12 см; по талии 10–14 см' },
];

const easeAllowanceData = [
    { zone: 'Грудь', rtw: '4–6', plusSize: '6–10', note: 'Tailored fit: минимальная прибавка; oversize: до 10 см' },
    { zone: 'Талия', rtw: '2–4', plusSize: '4–8', note: 'Для смокингов и жакетов с поясом прибавка уменьшается' },
    { zone: 'Бёдра', rtw: '4–6', plusSize: '6–10', note: 'Важно для удлинённых жакетов и костюмов' },
    { zone: 'Плечо', rtw: '0,5–1', plusSize: '1–1,5', note: 'У Plus Size увеличенная посадка плеча для комфорта' },
    { zone: 'Пройма', rtw: '0,5', plusSize: '1,5–2', note: 'Расширенная armhole в Plus Size для движения' },
...
const practicalApplicationData = [
    ...
    { area: 'Size mapping e-com', feature: 'Сдвиг на +1 размер при конверсии IT→RU для оверсайз блейзеров' },
    ...
    { area: 'RTW vs Tailoring', feature: 'Tailoring имеет меньший ease и жёсткую структуру; RTW — мягкий фит' },
];


export function FitGuideSuitsDialog({ isOpen, onOpenChange, audience = 'women' }: FitGuideDialogProps) {
     if (audience === 'men') {
        return (
                ...
                <ScrollArea className="flex-1 -mx-6">
                    <div className="px-6 space-y-4">
                        ...
                        <Card>
                         ...
                         <Card>
                             <CardHeader><CardTitle>🧶 Практическое применение</CardTitle></CardHeader>
                             <CardContent>
                                <Table>
                                    <TableHeader>
                                        <TableRow>
