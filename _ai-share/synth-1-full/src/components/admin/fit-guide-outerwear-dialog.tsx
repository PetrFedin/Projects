...
const fitPhilosophyData = [
    { subcategory: 'Пальто (Coat)', philosophy: 'Женственный силуэт, ease по груди 8–12 см', features: 'Важно контролировать баланс плеча и талии; для Plus Size линия плеча расширяется на +1,5–2 см' },
    { subcategory: 'Тренч (Trench)', philosophy: 'Приталенный силуэт, талия акцентирована', features: 'Ease 10 см по груди; британская посадка длиннее, итальянская — выше талии' },
    { subcategory: 'Парка (Parka)', philosophy: 'Relaxed fit, высокая мобильность', features: 'Ease 12–16 см; регулируемая талия; пройма увеличена на +2 см' },
    { subcategory: 'Пуховик (Down Coat)', philosophy: 'Oversized или cocoon', features: 'Ease до 18 см; рукав расширен; длина mid–calf в среднем 110–120 см' },
    { subcategory: 'Куртка (Jacket)', philosophy: 'Короткая посадка, баланс на плечах', features: 'Ease по груди 8–10 см; длина 55–65 см; biker — узкая талия, bomber — расширенная' },
    { subcategory: 'Жилет (Vest)', philosophy: 'Средняя длина, layering-friendly', features: 'Ease по груди 6–10 см; плечи укорочены; часто без талиевого акцента' },
    { subcategory: 'Плащ (Raincoat)', philosophy: 'Свободный или поясной силуэт', features: 'Ease по груди 10–14 см; акцент на равномерности длины и свободе проймы' },
];
...
export function FitGuideOuterwearDialog({ isOpen, onOpenChange, audience = 'women' }: FitGuideOuterwearDialogProps) {
