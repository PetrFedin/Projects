...
const constructionParamsData = [
    { element: 'Высота каблука (Heel)', value: '5–20 мм', comment: 'минимальный, обеспечивает плавный перекат' },
    ...
    { element: 'Профиль арки (Arch)', value: 'умеренный / низкий', comment: 'допускается flat foot-friendly' },
    ...
    { element: 'Материалы', value: 'кожа, замша, knit, текстиль', comment: 'допускается стрейч верх, важно усиление пятки' },
];

const fitAndTolerancesData = [
    { parameter: 'Ease (внутренний запас)', rtw: '5–7 мм', comfortFit: '6–8 мм', comment: 'комфорт без соскальзывания пятки' },
    { parameter: 'Полнота (width)', rtw: 'F–H', comfortFit: 'G–W', comment: 'большинство comfort моделей G/H' },
    { parameter: 'Подъём (instep)', rtw: '6.0 см', comfortFit: '6.5 см', comment: 'регулируется эластичной вставкой' },
    { parameter: 'Пяточная фиксация', rtw: 'стандарт', comfortFit: 'усиленная', comment: 'возможна кожаная подкладка или кант' },
    { parameter: 'Форма мыска (Toe form)', rtw: 'round / almond', comfortFit: 'round / square', comment: 'round даёт больше свободы при длительном ношении' },
];

const subcategoryFitData = [
    { subcategory: 'Балетки (Ballet Flats)', philosophy: 'Minimal Fit', features: 'мягкая колодка, низкий каблук, гнущаяся подошва' },
    { subcategory: 'Лоферы (Loafers)', philosophy: 'Structured Fit', features: 'жёсткая пятка, фиксированный подъём' },
    { subcategory: 'Мокасины (Moccasins)', philosophy: 'Adaptive Fit', features: 'мягкий верх, сшивной носок, удобная стелька' },
    { subcategory: 'Мюли (Mules)', philosophy: 'Open Fit', features: 'открытая пятка, более плотный свод' },
    { subcategory: 'Эспадрильи (Espadrilles)', philosophy: 'Summer Fit', features: 'подошва из джута, drop до 5 мм' },
];
...
const materialTechData = [
    ...
    { parameter: 'Противоскольжение', value: '≥0.5 коэффициент трения', comment: 'ISO стандарт для indoor/outdoor' },
            ...
            <DialogContent className="max-w-6xl h-[90vh]">
                ...
                <ScrollArea className="flex-1 -mx-6">
                    <div className="px-6 space-y-4">
                        ...
                        <Card>
                             <CardHeader><CardTitle>⚙️ Материальные и технологические параметры</CardTitle></CardHeader>
                             <CardContent>
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                         ...
                         <Card>
                             ...
                             <CardContent className="text-sm space-y-2">
                                <p><strong>Назначение:</strong> повседневная, офисная, домашняя</p>
                                <p><strong>Комфортная температура носки:</strong> 15–28 °C</p>
                                <p><strong>Основной риск:</strong> сползание пятки и заломы верха</p>
                                <p><strong>Рекомендованный материал верха:</strong> кожа, knit, текстиль</p>
                                <p><strong>Рекомендуемая плотность подошвы:</strong> 0.9 г/см³</p>
                                <p><strong>Оптимальный drop:</strong> 0–2 мм (естественная походка)</p>
                                <p><strong>Срок службы:</strong> 35 000 шагов без потери формы</p>
                             </CardContent>
                        </Card>
                    </div>
                </ScrollArea>
