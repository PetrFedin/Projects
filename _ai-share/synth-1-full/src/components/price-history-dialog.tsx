        ...
        <div className="py-4">
            <ResponsiveContainer width="100%" height={400}>
                 <LineChart
                    ...
                    />
                    <Legend />
                    <Line type="monotone" dataKey="Syntha" stroke="hsl(var(--primary))" strokeWidth={3} dot={false} />
                    <Line type="monotone" dataKey="ЦУМ" stroke="hsl(var(--chart-2))" strokeWidth={2} dot={false} />
                    <Line type="monotone" dataKey="Lamoda" stroke="hsl(var(--chart-3))" strokeWidth={2} dot={false} />
                </LineChart>
            </ResponsiveContainer>
        </div>
      </DialogContent>
