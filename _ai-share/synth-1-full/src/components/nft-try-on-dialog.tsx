...
export default function NftTryOnDialog({ nft, isOpen, onOpenChange }: NftTryOnDialogProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-4xl grid grid-cols-1 md:grid-cols-2 p-0">
                <div className="p-4 flex flex-col">
                    <DialogHeader>
                        <Badge variant="outline" className="w-fit">Цифровой актив</Badge>
                        <DialogTitle className="text-base font-bold mt-2">{nft.name}</DialogTitle>
                ...
                <div className="bg-secondary/50 flex items-center justify-center p-4 rounded-r-lg relative">
                    {avatarImage && (
                        <Image
                    ...
                    <div className="absolute bottom-4 left-4 flex items-center gap-2 bg-background/50 p-2 rounded-lg backdrop-blur-sm">
