...
import type { HubSidebarHeaderProps } from '@/components/hub/HubSidebarHeader';

function HubSidebarHeaderPlaceholder({ profile }: Pick<HubSidebarHeaderProps, 'profile'>) {
  return (
...
const HubSidebarHeader = dynamic(
  ...
  { ssr: false, loading: () => <HubSidebarHeaderPlaceholder /> }
);
