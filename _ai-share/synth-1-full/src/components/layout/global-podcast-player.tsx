                ...
                <div className="container mx-auto px-4 h-10 flex items-center justify-between">
                    <div className="flex items-center gap-3 overflow-hidden">
                        <div className="relative h-10 w-10 flex-shrink-0 rounded-md overflow-hidden bg-muted">
                            <Image src={playingPodcast.imageUrl} alt={playingPodcast.description} fill className="object-cover" />
                        </div>
                        <div className="overflow-hidden">
                            <p className="text-sm font-semibold truncate flex items-center gap-1.5">
                                <Radio className="h-4 w-4 text-red-500 animate-pulse-live flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button variant="ghost" size="icon" className="h-8 w-8 hover:bg-black/10" onClick={() => setPlayingPodcast(null)}>
                            <X className="h-5 w-5" />
                        </Button>
                    </div>
                </div>
