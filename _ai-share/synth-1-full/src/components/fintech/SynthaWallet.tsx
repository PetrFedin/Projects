...
const ROLE_DATA = {
  brand: {
    title: 'Оптовый капитал',
    entity: 'Бренд · Syntha',
    tier: 'Enterprise',
    cardStatus: 'Active',
    cardStyle: 'bg-gradient-to-br from-[#1e293b] via-[#0f172a] to-black',
    balanceLabel: 'Доступно',
    escrowLabel: 'Эскроу производства',
    creditLabel: 'Стратегическая линия',
    stats: {
      balance: 12480000,
      escrow: 4500000,
      bonus: 240000,
    ...
    aiAdvice:
      'Анализ ликвидности: избыток 4,2 млн ₽ под хеджирование сырья. Индекс «премиум-меринос» в Q3 +12,4%. Рекомендация: зафиксировать закупки по текущим условиям.',
    features: [
      {
        id: 'f-b1',
        name: 'Финансирование под производство',
        desc: 'Предоплата циклов с оценкой риска (AI)',
        icon: Zap,
        status: 'active',
      },
      {
        id: 'f-b2',
        name: 'Роялти и выплаты',
        desc: 'Распределение по правообладателям и дизайнерам',
        icon: History,
        status: 'active',
      },
      {
        id: 'f-b3',
        name: 'Резерв под пошлины',
        desc: 'НДС, таможня и импорт — провизии',
        icon: ShieldCheck,
        status: 'setup',
      },
    ],
    transactions: [
      {
        ...
        type: 'income',
        category: 'Retail',
        title: 'Отчёт ЦУМ: продажи января',
        amount: 4200000,
        date: '2026-02-04',
        status: 'completed',
      },
      {
        ...
        type: 'expense',
        category: 'Factory',
        title: 'Оплата производства капсулы Winter',
        amount: 1850000,
        date: '2026-02-02',
        status: 'completed',
      },
  ...
  shop: {
    title: 'Розничная ликвидность',
    entity: 'Ритейл · операционный хаб',
    tier: 'Business Pro',
    cardStatus: 'Active',
    cardStyle: 'bg-gradient-to-br from-[#2d3a8c] via-[#1e293b] to-[#0f172a]',
    balanceLabel: 'Оборотные средства',
    escrowLabel: 'B2B предзаказы',
    creditLabel: 'Кредит на сток',
    stats: {
      balance: 2850000,
      escrow: 1200000,
      bonus: 85000,
    ...
    aiAdvice:
      'Пропускная способность розницы в феврале +18% к плану. Остатки по категории «шерсть» — 12%. Рекомендация: рассрочка на пополнение склада до пика выходных.',
    features: [
      {
        id: 'f-s1',
        name: 'Рассрочка на инвентарь',
        desc: 'Пополнение стока с отсрочкой по обороту',
        icon: ShoppingCart,
        status: 'active',
      },
      {
        id: 'f-s2',
        name: 'Синхронизация с кассой',
        desc: 'Ликвидность с торговых точек в реальном времени',
        icon: RefreshCcw,
        status: 'active',
      },
      {
        id: 'f-s3',
        name: 'НДС и отчётность',
        desc: 'Начисления и платежи по налогам',
        icon: FileText,
        status: 'active',
      },
    ],
    transactions: [
      {
        ...
        type: 'income',
        category: 'B2C',
        title: 'Ежедневный отчёт касс (POS)',
        amount: 420000,
        date: '2026-02-04',
        status: 'completed',
      },
      {
        ...
        type: 'expense',
        category: 'Stock',
        title: 'B2B закупка: шерстяная линейка',
        amount: 850000,
        date: '2026-02-03',
        status: 'completed',
      },
  ...
  client: {
    ...
    entity: 'Стиль-счёт клиента',
    tier: 'Платина',
    cardStatus: 'Active',
    cardStyle: 'bg-gradient-to-br from-[#4f46e5] via-[#3730a3] to-[#1e1b4b]',
    balanceLabel: 'Баланс',
    escrowLabel: 'Резерв под возвраты',
    creditLabel: 'Лимит покупок',
    stats: {
      balance: 145000,
      escrow: 8500,
      bonus: 12400,
    ...
    aiAdvice:
      'Уровень залога по гардеробу вырос. Рекомендация: открыть кредитную линию до 250 тыс. ₽ под весеннюю коллекцию.',
    features: [
      {
        id: 'f-c1',
        name: 'Залог гардероба',
        desc: 'Кредит под цифровой гардероб',
        icon: Gem,
        status: 'active',
      },
      {
        id: 'f-c2',
        name: 'Ликвидность под залог',
        desc: 'Транши под проверенные вещи',
        icon: RefreshCcw,
        status: 'active',
      },
      {
        id: 'f-c3',
        name: 'Страхование образа',
        desc: 'Микрострахование дорогих позиций',
        icon: ShieldCheck,
        status: 'active',
      },
    ],
    transactions: [
      ...
      },
      {
        ...
        type: 'bonus',
        category: 'Missions',
        title: 'Бонус за загрузку гардероба',
        amount: 500,
        date: '2026-02-01',
        status: 'credited',
      },
  ...
  manufacturer: {
    title: 'Выплаты производству',
    entity: 'Производственный контур',
    tier: 'Industrial Gold',
    cardStatus: 'Verified',
    cardStyle: 'bg-gradient-to-br from-[#065f46] via-[#064e3b] to-[#022c22]',
    balanceLabel: 'Доступно к выплате',
    escrowLabel: 'Незавершёнка (WIP)',
    creditLabel: 'Линия на материалы',
    stats: {
      balance: 8900000,
      escrow: 12400000,
      bonus: 45000,
    ...
    aiAdvice:
      'Партия №42 готова на 92%. Рекомендация: факторинг цепочки поставок под выплату 8,5 млн ₽ и закупку следующей партии ткани со скидкой поставщика 5%.',
    features: [
      {
        id: 'f-m1',
        name: 'Факторинг SCF',
        desc: 'Досрочная оплата отгруженных партий',
        icon: Zap,
        status: 'active',
      },
      {
        ...
        desc: 'Финансирование станков и линий',
        icon: Building2,
        status: 'active',
      },
      {
        id: 'f-m3',
        name: 'Эскроу под ФОТ',
        desc: 'Резерв на зарплату по этапам',
        icon: User,
        status: 'active',
      },
    ],
    transactions: [
      {
        ...
        type: 'income',
        category: 'Milestone',
        title: 'Выплата за завершение партии №42',
        amount: 3200000,
        date: '2026-02-04',
        status: 'completed',
      },
      ...
      },
      {
        ...
        type: 'escrow',
        category: 'Quality',
        title: 'Удержание ОТК до приёмки',
        amount: 450000,
        date: '2026-01-30',
        status: 'locked',
      },
