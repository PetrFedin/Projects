...
import { Star, Repeat, Minus, Plus, ShoppingCart, Heart, Scale, Share2, View, Sparkles, PlusCircle } from 'lucide-react';
...
export const DetailPreview = forwardRef<HTMLDivElement, { settings: Record<string, boolean>, product: any }>(({ settings, product: mockProduct }, ref) => {
