    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Подробное описание функций, доступных в каждом из планов для ритейлеров.</CardDescription>
            </CardHeader>
            <CardContent>
                <TooltipProvider>
                            ...
                            <TableBody>
                                {shopFeaturesData.map((row) => (
                                    <TableRow key={row.feature}>
                                        ...
                                        <TableCell className={cn("text-center font-semibold", plansMeta[1].variant === 'default' && "bg-primary/5")}>{row.pro}</TableCell>
