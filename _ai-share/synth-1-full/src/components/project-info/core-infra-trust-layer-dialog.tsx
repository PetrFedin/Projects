...
const techStackData = [
  ...
  {
    level: 'Платежи (ЮKassa, СБП, банк; Stripe при экспорте), ЭП (Контур, СБИС, Госключ)',
    self: '➕',
    api: '✅',
  },
                ...
                <CardContent className="space-y-2 text-sm">
                  <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                    ...
                    <li>
                      ...
                      Shopify, Notion, Airtable; ЮKassa / СБП / банк + Stripe при экспорте;
                      CryptoBot; Контур / СБИС / Госключ — электронная подпись и ЭДО (63-ФЗ).
                    </li>
                    <li>
