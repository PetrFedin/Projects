...
export function FinancialSustainabilityDialog({
  isOpen,
  onOpenChange,
}: FinancialSustainabilityDialogProps) {
  return (
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <div className="space-y-4 py-4 text-sm">
          <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
            <li>
              Диверсифицированная монетизация: комиссии, подписки, AI-сервисы, аналитика, лицензии.
            </li>
          ...
          <p className="flex items-start gap-2 pt-2 font-semibold text-foreground">
            ...
            Результат: платформа финансово устойчива и способна масштабироваться без внешнего
            капитала на ранних этапах.
          </p>
        </div>
        <DialogFooter>
