  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          <DialogTitle>
            Массовое действие: {isPromo ? 'Предложить промо-акцию' : 'Предложить перенос в Аутлет'}
          </DialogTitle>
          <DialogDescription>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  isPromo ? setPromoCode(e.target.value) : setDiscount(Number(e.target.value))
                }
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isLoading || (isPromo ? !promoCode : discount <= 0)}
          >
