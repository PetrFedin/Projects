        ...
        <div className="container mx-auto px-4 py-4">
            <header className="mb-8 flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-base font-bold font-headline">Кабинет магазина</h1>
                        <p className="text-muted-foreground">Управляйте розничными продажами и оптовыми закупками.</p>
                    </div>
                </div>
                 <Popover>
                    ...
                    <PopoverContent className="w-80 p-0">
                        ...
                        <div className="p-4 space-y-3 text-sm">
                            <p><span className="font-semibold">Syntha</span> согласовал ваш заказ <span className="font-mono">#B2B-0012</span>.</p>
                             <p><span className="font-semibold">A.P.C.</span> опубликовал новую коллекцию.</p>
                             <p>Товар <span className="font-semibold">"Шелковое платье-миди"</span> от Syntha снова в наличии.</p>
                        </div>
                    </PopoverContent>
                </Popover>
            </header>
