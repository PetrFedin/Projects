...
export function useStoryViewer(
    ...
    const [lookSelections, setLookSelections] = useState<Record<string, Array<{ colorId: string, size: string, qty: number }>>>({});
    ...
    return {
        ...
        isBuyLookOpen, setIsBuyLookOpen,
        isLookOrdered, setIsLookOrdered,
        isContactStepOpen, setIsContactStepOpen,
        isLivePlayerOpenFromStory, setIsLivePlayerOpenFromStory,
        lookSelections, updateLookSelection,
        editingContactId, setEditingContactId,
        tempContactValue, setTempContactValue,
        contactMethod, setContactMethod,
        contactTime, setContactTime,
        selectedContactDate, setSelectedContactDate,
        selectedContactTimeStr, setSelectedContactTimeStr,
        currentGalleryIdx, setCurrentGalleryIdx,
        userProfile, setUserProfile,
        lookPriceLabel, isAnyPreOrderInSelection
    };
}
