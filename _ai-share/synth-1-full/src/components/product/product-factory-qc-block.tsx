    ...
    <Card className="mt-4 border-dashed bg-muted/20">
      <CardHeader className="pb-2">
        ...
        <CardDescription className="text-xs">
          Результаты финальной инспекции на фабрике.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant={qc.overallResult === 'approved' ? 'default' : 'destructive'}
        ...
        <p className="pt-1 text-[10px] italic leading-tight text-muted-foreground">
