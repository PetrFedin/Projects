...
export const FORMATS = [
  { id: "all", label: "Полный образ", items: ["Tops", "Bottoms", "Shoes"] as Product["category"][] },
  { id: "base", label: "Только база", items: ["Tops", "Bottoms"] as Product["category"][] },
  { id: "acc", label: "С аксессуарами", items: ["Tops", "Bottoms", "Shoes", "Accessories"] as Product["category"][] },
