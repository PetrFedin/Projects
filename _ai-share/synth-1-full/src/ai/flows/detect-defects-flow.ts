...
const DefectSchema = z.object({
  type: z.string().describe('Тип дефекта, например "Пятно", "Кривой шов", "Разрыв", "Затяжка" и т.д.'),
  ...
  }).describe('Координаты и размеры области дефекта в процентах относительно ширины и высоты изображения (от 0 до 100)'),
});
