...
export const getProductDetails = ai.defineTool(
  {
    ...
    inputSchema: z.object({
      query: z.string().describe('The name or keywords of the product to search for. For example, "cashmere sweater" or "trench coat".'),
    }),
  ...
  async ({ query }) => {
    ...
    if (foundProduct) {
        ...
        return {
            ...
            description: foundProduct.description.length > 300 
