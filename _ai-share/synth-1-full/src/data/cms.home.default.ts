...
export const DEFAULT_HOME_CMS: CmsHomeConfig = {
  hero: {
    ...
    subtitle:
      'Создавай, презентуй и продавай коллекции в AI-экосистеме. Phygital. Аналитика. Комьюнити.',
  ...
  stories: [
    {
      id: 's1',
      title: 'Новый дроп недели',
      cover: 'https://images.unsplash.com/photo-1539533018447-63fcce2678e3?q=80&w=800',
      href: '/search?q=drop',
      tag: 'DROP',
    },
    {
      id: 's2',
      title: 'Образы комьюнити',
      cover: 'https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?q=80&w=800',
      href: '/looks',
      tag: 'COMMUNITY',
    },
    {
    ...
    },
    {
      id: 's4',
      title: 'AR Preview',
      cover: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=800',
      href: '/ar',
      tag: 'AR',
    },
  ],
  ...
  carousels: [
    {
      id: 'c1',
      title: 'Новинки',
      subtitle: 'Последние добавления',
      productSlugs: [
        'cashmere-crewneck-sweater',
        'performance-work-pant',
        'silk-midi-dress',
    ...
    },
    {
      ...
      productSlugs: ['kids-tech-hoodie', 'girls-floral-dress', 'baby-organic-onesie'],
    },
  ],
