...
**Архив плана (до вычищения донора).** Актуальный канон: **`_ai-share/synth-1-full`**. Субмодуль **`synth-1/`** из монорепо **удалён**; ниже по тексту **`synth-1/`** — исторический контекст на момент составления.
